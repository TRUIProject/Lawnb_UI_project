		...
		<div class="container-inner">
			<div class="container-left">
				<div class="scroll-y">
					<h2 class='h2'>판례</h2>
					<div class="btn-wrap">
						<div class="chk-dot-wrap mb-15">
							<input type="checkbox" id="multi-yn" value="Y" name="multi-yn">
							<label for="multi-yn"><span class="dot mr-5"></span> 멀티선택</label>
						</div>
						<div class="ta-c">
							<button class="btn btn-none btn-m icon-reset">초기화</button>
							<button class="btn btn-blue btn-m icon-application">적용</button>
						</div>
					</div>
					<ul id="left-con-accordion" class="accordion">
						...
						<li class="accordion-item">
							<h2 class="accordion-header">
								<button class="accordion-button show" type="button" data-bs-target="#left-con-accordion00">
									키워드
								</button>
							</h2>
							<div id="left-con-accordion00" class="accordion-collapse collapse" data-bs-parent="#left-con-accordion">
								<div class="search-input">
									<label>
										<input type="text" placeholder="" name="keyword" class="input-text">
									</label>
								</div>
							</div>
						</li>
					...
					<div class="btn-wrap border-top">
						<div class="ta-c">
							<button class="btn btn-blue btn-m icon-reset">초기화</button>
						</div>
					</div>
				</div>
			</div>
			<div class="container-right">
				...
				<div class="reset-con-list pt-20">
					<div class="reset-con-item">
						<h2 class="right-header">최근 조회 ESG</h2>
					...
					<ul class="content-ul">
						<li>
							<div class="li-con">
								...
								<div class="txt-div">
									<a href="" class="txt01">대법원 2016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 888 ]2016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 82016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 8</a>
									<p class="mt-10">
										&lt;별칭사건명 별칭사건명 별칭사건명&gt;<br>
										속보 요약정보 중 일부 구 대학교원의 임용권자가 임용기간이 만료된 조교수에 대하여 재임용을거부하는 취지로 한 임용기간만료의 통지가 행정소송의 대상이 되는 처분에해당하는지 여부(적극)
									</p>
								</div>
							</div>
						</li>
