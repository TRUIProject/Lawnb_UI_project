	...
	<div class="container-wrap">
		<div class="container-inner">
			...
			<div class="container-center02">
				<div class="clear">
					<div class="c-right con-center content-nav-warp">
						<ul class="ul-style02">
							<li class="on"><a href="">가이던스</a></li>
							<li><a href="">온주</a></li>
							<li><a href="">판례</a></li>
						</ul>
					</div>
				...
				<div class="clear">
					...
					<div class="c-right con-center clear">
						<div class="mb-15 clear">
							<div class="c-left">
								<div class="btn-list btn-list-l btn-list-none">
									<button class="btn">전문 판례</button>
									<button class="btn on">등재예정판례<span class="icon icon-exclamation-circle icon-w18 ml-2"></span></button>
								</div>
							</div>
							<div class="c-right clear">
								<button class="btn-blue btn-m">상세검색</button>
							</div>
						</div>
						...
						<ul class="content-ul">
							<li>
								<div class="li-con">
									<input type="checkbox" id="con-1" class="input-chk" value="판례" name="keyword-list02">
									<div>
										<a href="">대법원 2016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 888 ]2016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 82016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 8</a>
										<p>
							...
							<li>
								<div class="li-con">
									<input type="checkbox" id="con-1" class="input-chk" value="판례" name="keyword-list02">
									<div>
										<a href="">대법원 2016. 5. 27. 선고 2014두8490 판결 【도로점용허가처분무효확인등】 종국결과 [공2016하, 888 ] </a>
										<p>
											&lt;별칭사건명 별칭사건명 별칭사건명&gt;<br>
											속보 요약정보 중 일부 구 대학교원의 임용권자가 임용기간이 만료된 조교수에 대하여 재임용을거부하는 취지로 한 임용기간만료의 통지가 행정소송의 대상이 되는 처분에해당하는지 여부(적극)
										</p>
