		...
		<div class="container-center">
			...
			<div class="clear mb-20">
				<div class="c-left clear">
					<button class="btn-none btn-m c-left mr-5">선택삭제</button>
					<button class="btn-none btn-m c-left"><div class="str pr-20">메모<p class="n-i n-i-w15 n-i-alert-cir str-rm"></p></div></button>
				</div>
				...
				<div class="content-div-wrap">
					<div class="content-div flex-table">
						<div class="flex-tr">
							...
							<div class="li-con">
                                <a href="" class="c-blue fs-16 dis-b">제목입니다</a>
