...
<div class="container-wrap">
	<div class="container-inner">
			...
			<div class="direct-list">
				<div class="direct-item">
					<div class="clear mb-5">
						<h2 class="c-left right-header">인기 서식</h2>
					</div>
					<ul class="direct-ul">
						<li>
							<a href="">
								<span class="c-blue">법인세 등 부과처분취소 청구의 소</span>
								<span class="c-black">행정소송서식사례집</span>
							</a>
						</li>
						<li>
							<a href="">
		...
		<div class="container-center">
			<h2 class="sub-main-tit clear">전문법률서식 검색</h2>
			<div class="bg-border">
				<div class="sub-main-pd">
					<div class="sub-main-tab-warp clear">
						<ul class="sub-main-tab-ul c-left">
							<li class="on"><a href="./legalForm_submain01.php">전문법률서식 검색</a></li>
							<li><a href="./legalForm_submain02.php">도서목록</a></li>
						</ul>
							...
							<div class="con">
								...
								<div class="input-box str">
									<div class="dis-t">
										<div class="dis-tr">
											<div class="dis-th">
												<label for="keyword-except">도서선택</label>
											</div>
											<div class="dis-tc">
