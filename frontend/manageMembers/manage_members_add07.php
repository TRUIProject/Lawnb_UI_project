					...
					<div class='container-left-pd'>
						<div class='index-list'>
							<ol class='index-ul'>
								...
								<li id='RegistLevel_7' class='on'><a href='#law_refer' onclick="javascript:RegistLevel('7'); return false;">기타/첨부파일</a></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class='sub-main-con'>
									<div class='con doc max-w100'>
										<div class='input-box str'>
											<p class='fs-16 fw-700'>기타 요청사항 <em class='txt_info'>기타 요청사항이 있으면 입력해 주세요.</em></p>
										</div>
										<div class='input-box str'>
									...
									<div class='con doc max-w100'>
										<div class='input-box str'>
											<div class='dis-t'>
												<div class='dis-tr'>
													<div class='dis-th'>첨부파일</div>
													<div class='dis-tc'>
														<div class="input-file">
															<input id='sFileName' type='file' class='input-css01'>
															<label for='sFileName' class='label-file'>파일 선택</label>
															<span id='file-name'></span>
														</div>
														<div class='txt_info'>파일이 여러 개일 경우에는 압축하여 업로드 하시면 됩니다.(단, 첨부가능한
															최대 용량은 10MB 입니다.)
														</div>
													</div>
												</div>
...
<script>
    $('#sFileName').on('change', function () {
        const fileName = $(this).val().split('\\').pop(); // 파일명만 추출
