	...
	<div class="container-inner vh-m">
		...
		<div class="container-writer">
			<div class="pt-30 pb-50">
				<div id='ConnectLawyerLayer' style=''>
					<div id='ModConnTitleLayer' class='status_txt mgt20' style='display: none;'>회원님 ID와 아래의 법조인을
						연결합니다.
					</div>
					<div id='ModConnLawyerLayer' class='lawyer_list' style='display: none;'>
						<ul id='ConnectLawyerInfo'></ul>
					</div>
					<div id='ConnectAlertLayer' class='etc_info' style='display: none;'>본인의 법조인이 맞는지 다시 한번 확인해 주세요. <br>만약
						다른 법조인으로 잘못 신청되는 경우, 로앤비 운영자가 임의로 연결을 거절하거나 추후 삭제할 수 있습니다.
					</div>
					...
					<div class='policy_agree'>
						...
						<div>법조인명록의 신규등록/수정/연결/삭제 및 승소판결문 등록 신청시에 입력하는 연락처 및 입력내용은 요청하신 사항을 처리하고, 진행상황에 대한 안내 및 그 내역을
							보관하는 용도로 사용됩니다. <a href='#' onclick='javascript:Popup_LawyerCollection(); return false;'>상세내용</a>
						</div>
