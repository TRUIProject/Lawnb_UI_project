					...
					<div class='container-left-pd'>
						<div class='index-list'>
							<ol class='index-ul'>
								...
								<li id='RegistLevel_5' class='on'><a href='#law_refer' onclick="javascript:RegistLevel('5'); return false;">경력정보</a></li>
								...
								<div class='sub-main-con'>
									<div class='con doc max-w100'>
										<div class='input-box clear'>
											<p class='c-left fs-16 fw-700'>경력</p>
											<div class='c-right'>
												<button class="btn btn-none btn-m" onclick='addCareerRow()'>경력 추가</button>
											</div>
										</div>
										<div class='input-box str'>
											<table id="career-table" class='table-css02'>
												<colgroup>
													<col width=''>
													<col width='100px'>
													<col width='100px'>
											...
											<div class='txt_info'>경력 입력예<br>
												- 예1 : 서울고등법원 민사부/민사1부(노동), 부장판사<br>
												- 예2 : 소속-법무법인 한국. 지적재산권 저작권파트<br>
												- 예3 : 독일 뮌헨 지방법원 사법연수생 Second Judicial State Examination
											</div>
										</div>
									</div>
									<div class='con doc max-w100'>
										<div class='input-box clear'>
											<p class='c-left fs-16 fw-700'>사회활동</p>
											<div class='c-right'>
												<button class='btn btn-none btn-m' onclick='addActivitiesRow()'>사회활동 추가
												</button>
											</div>
										</div>
										<div class='input-box str'>
											<table id='activities-table' class='table-css02'>
												<colgroup>
													<col width=''>
												</colgroup>
												<thead>
									...
									<div class='con doc max-w100'>
										<div class='input-box str'>
											<p class='fs-16 fw-700'>경력/사회활동 추가 요청사항 <em class='txt_info'>입력 양이 많거나 별도 요청이 있으면 입력해 주세요.</em></p>
										</div>
										<div class='input-box str'>
...
<script>
  ...
  `;
        $('#career-table tbody').append(rowHtml);
    }
    // 사회활동 행 추가 함수 (전역 범위)
    function addActivitiesRow() {
        activitiesIndex++;
        const indexStr = activitiesIndex.toString().padStart(2, '0');
        const rowHtml = `
    <tr>
		<td><input type='text' class='input-css01'></td>
	</tr>
  `;
        $('#activities-table tbody').append(rowHtml);
    }
</script>
</body>
</html>
