					...
					<div class='container-left-pd'>
						<div class='index-list'>
							<ol class='index-ul'>
								...
								<li id='RegistLevel_3' class='on'><a href='#law_refer' onclick="javascript:RegistLevel('3'); return false;">시험정보</a></li>
								...
								<div class='sub-main-con'>
									<div class='con doc'>
										<div class='input-box str'>
											<p class="fs-16 fw-700">시험정보</p>
										</div>
										<div class='input-box str'>
											<div class='dis-t'>
												<div class='dis-tr'>
													<div class='dis-th'>시험종류</div>
													...
													<div class='dis-th'>시험회차</div>
													<div class='dis-tc w-100px'>
														<div class='dis-t'>
															<div class='dis-tr'>
																<div class='dis-tc pr-5'><input id='keyword-except'
																                                type='text'
																                                class='input-css01'>
																</div>
									...
									<div class='con doc'>
										<div class='input-box str'>
											<p class='fs-16 fw-700'>시험정보 추가 요청사항 <em class='txt_info'>외국시험 합격 등 별도 요청이 있으면 입력해 주세요.</em></p>
										</div>
										<div class='input-box str'>
