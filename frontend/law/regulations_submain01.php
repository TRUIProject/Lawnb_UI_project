...
<div class="container-wrap">
	<div class="container-inner">
			...
			<div class="direct-list pt-20">
				<div class="direct-item">
					<div class="clear mb-5">
						<h2 class="c-left right-header">최신 자치법규</h2>
						<div class="c-right">
	    ...
	    <div class="container-center">
	        <h2 class="sub-main-tit clear">자치법규</h2>
	        <div class="bg-border">
	            <div class="sub-main-pd">
	                <div class="sub-main-tab-warp clear">
	                    <ul class="sub-main-tab-ul c-left">
	                        <li class="on"><a href="./regulations_submain01.php">자치법규</a></li>
	                            ...
	                            <div id="toggle01" class="search-area-con">
		                            <div class="input-box str mt-20">
			                            <div class="dis-t">
				                            <div class="dis-tr">
					                            <div class="dis-th">
						                            <label for="keyword-except">자치법규명</label>
					                            </div>
					                            <div class="dis-tc">
		                            ...
		                            <div class="input-box str">
			                            <div class="dis-t">
				                            <div class="dis-tr">
					                            ...
					                            <div class="dis-tc">
						                            <button class="btn-none btn-m">선택</button>
					                            </div>
				                            </div>
			                            </div>
		                            </div>
