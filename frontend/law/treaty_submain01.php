...
<div class="container-wrap">
	<div class="container-inner">
	    ...
	    <div class="container-center">
	        <h2 class="sub-main-tit clear">조약 검색</h2>
	        <div class="bg-border">
	            <div class="sub-main-pd">
	                <div class="sub-main-tab-warp clear">
	                    <ul class="sub-main-tab-ul c-left">
	                        <li class="on"><a href="./treaty_submain01.php">조약 검색</a></li>
	                        ...
	                        <div class="con">
		                        ...
		                        <div class="input-box str">
			                        <div class="dis-t">
				                        <div class="dis-tr">
					                        <div class="dis-th">
						                        <label for="keyword-except">구분</label>
					                        </div>
					                        <div class="dis-tc">
		                                        ...
		                                        <div class="dis-tc">
			                                        <ul class="keyword-chk-list">
	                                                    ...
	                                                    <li>
	                                                        ...
	                                                        <label for="keyword-2-2">양자조약</label>
	                                                    </li>
	                                                    <li>
	                                                        <input type="checkbox" id="keyword-2-3" value="" name="keyword-list">
	                                                        <label for="keyword-2-3">다자조약</label>
	                                                    </li>
	                                                </ul>
		                                        </div>
		                                    </div>
