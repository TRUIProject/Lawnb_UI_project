	...
	<div class="ct-left">
		<div class="ct-pt h-100p">
			<div class="str h-100p">
				<div class="ct-scroll">
					<div id="table-index-tab" class="table_index tree">
						<div class='btn-list btn-list-m btn-list-none'>
							<button class='tab-li btn on' onclick="fn_tab_toggle(this)" data-tab-id='#table-index-tab' data-tab-con='#content-list'>조문목차</button>
							<button class='tab-li btn' onclick='fn_tab_toggle(this)' data-tab-id='#table-index-tab' data-tab-con='#historical-list'>연혁목차</button>
						</div>
						<div id='content-list' class='table_index_con on'>
							<ul class='regulation'>
								<li class='active_d1 open'>
									...
									<ul>
										<li class='comment'><a name='joMoveLink' href='#P1'
										                       onclick="law.goTarget('1')"><span>제1조</span> (목적)</a>
										</li>
										<li class='comment'><a name='joMoveLink' href='#P2'
										                       onclick="law.goTarget('2')"><span>제2조</span> (정의)</a>
										</li>
										...
										<li class='comment open'>
											...
											<ul>
												...
												<li class='comment'><a name='joMoveLink' href='#P9'
												                       onclick="law.goTarget('9')"><span>제9조</span> (궤간의
														공차)</a>
												</li>
											</ul>
										</li>
								...
								<li class='active_d1 open'>
									...
									<ul>
										...
										<li class='comment'><a name='joMoveLink' href='#P34'
										                       onclick="law.goTarget('34')"><span>제34조</span> (승강장의 길이 및
												통로의 폭)</a>
										</li>
						...
						<div id='historical-list' class='table_index_con'>
							<!-- 여기에 조문연혁을 위치시켜 주세요. -->
							<ul>
								<li>목차</li>
							</ul>
		...
		<div class="ct-pt h-100p">
			<div class="ct-scroll">
				<div class="ct-pw">
					...
					<div class="border-b">
						<h3 class="ct-tit">관련 첨부 파일 총 2건</h3>
						<ul class="ul-dot mt-10 li-index-10">
							<li>
								<div class="dot-cell">
									<a href="" class="dis-b fs-14 c-blue">첨부파일.hwp</a>
								</div>
							</li>
							<li>
								<div class="dot-cell">
