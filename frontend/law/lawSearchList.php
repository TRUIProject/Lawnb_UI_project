						...
						<div class="li-con">
							...
							<div class="txt-box">
								<div class="clear">
									<div class="c-right clear">
										<div class="c-left">
											<button id="" class="btn btn-gray sub-law-btn" type="button" onclick='fn_sub_law(2)' >
												﻿조 검색 20건
											</button>
										</div>
										<button class="icon-plus icon-w25 c-left ml-10" onclick="fn_showPreviewPage(event)"></button>
						...
						<div class='li-con'>
							...
							<div class='txt-box'>
								<div class='clear'>
									...
									<div class='c-left clear mr-10'>
										<a href='' class='con-tit'><span class='badge-blue badge-small mr-2'>현행</span>
											<span class='highlight-yellow'>부동산</span>개발업의 관리 및 육성에 관한 법률 시행규칙 및 육성에 관한
											법률</a>
									</div>
								</div>
								<p class='text01 mt-10'>
