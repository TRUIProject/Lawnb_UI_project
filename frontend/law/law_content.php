...
<div class="ct-wrap">
		...
		<div class="ct-pt h-100p">
			<div class="str h-100p">
							...
							<li class="active_d1 open">
								...
								<ul>
									...
									<li class="comment"><a name="joMoveLink" href="#P3"
									                       onclick="law.goTarget('3')"><span>제3조</span> (선로의 형식)</a>
									</li>
									...
									<li class="comment"><a name="joMoveLink" href="#P5"
									                       onclick="law.goTarget('5')"><span>제5조</span> (열차의 운전 진로)</a>
									</li>
								</ul>
							</li>
							<li class="active_d1 open">
									...
									<li class="comment open">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P10"
											                       onclick="law.goTarget('10')"><span>제10조</span> (선로의
													곡선반경
													등)</a></li>
											...
											<li class="comment"><a name="joMoveLink" href="#P12"
											                       onclick="law.goTarget('12')"><span>제12조</span> (캔트의
													체감거리)</a>
											</li>
											...
											<li class="comment"><a name="joMoveLink" href="#P14"
											                       onclick="law.goTarget('14')"><span>제14조</span> (직선의
													삽입 등)</a>
											</li>
										</ul>
									</li>
									<li class="comment open">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P15"
											                       onclick="law.goTarget('15')"><span>제15조</span> (정거장
													밖의 기울기한도)</a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P16"
											                       onclick="law.goTarget('16')"><span>제16조</span> (정거장
													안의 기울기
													한도)</a></li>
											<li class="comment"><a name="joMoveLink" href="#P17"
											                       onclick="law.goTarget('17')"><span>제17조</span> (측선의
													기울기)</a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P18"
											                       onclick="law.goTarget('18')"><span>제18조</span> (종곡선)</a>
											</li>
										</ul>
									</li>
									<li class="comment">
									...
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P22"
											                       onclick="law.goTarget('22')"><span>제22조</span> (궤도의
													중심
													간격)</a></li>
											<li class="comment"><a name="joMoveLink" href="#P23"
											                       onclick="law.goTarget('23')"><span>제23조</span> (곡선인
													궤도의 중심
													간격)</a></li>
											...
											<li class="comment"><a name="joMoveLink" href="#P25"
											                       onclick="law.goTarget('25')"><span>제25조</span> (도상의
													두께 등)</a>
											</li>
										</ul>
									</li>
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P26"
											                       onclick="law.goTarget('26')"><span>제26조</span> (건축한계
													외의 여유
													공간)</a></li>
											<li class="comment"><a name="joMoveLink" href="#P27"
											                       onclick="law.goTarget('27')"><span>제27조</span> (도로면
													등으로부터의
													간격)</a></li>
											<li class="comment"><a name="joMoveLink" href="#P28"
											                       onclick="law.goTarget('28')"><span>제28조</span> </a>
											</li>
										</ul>
									</li>
									<li class="comment">
							...
							<li class="active_d1 open">
								...
								<ul>
									...
									<li class="comment"><a name="joMoveLink" href="#P33"
									                       onclick="law.goTarget('33')"><span>제33조</span> (승강장 연단과
											차량한계와의
											간격)</a></li>
									<li class="comment"><a name="joMoveLink" href="#P34"
									                       onclick="law.goTarget('34')"><span>제34조</span> (승강장의 길이 및 통로의
											폭)</a>
									</li>
									<li class="comment"><a name="joMoveLink" href="#P35"
									                       onclick="law.goTarget('35')"><span>제35조</span> (노면 출입구 및
											지상보행로)</a>
									</li>
									...
									<li class="comment">
										...
										<ul>
											...
											<li class="comment"><a name="joMoveLink" href="#P37"
											                       onclick="law.goTarget('37')"><span>제37조</span> (전선로)</a>
											</li>
											...
											<li class="comment"><a name="joMoveLink" href="#P39"
											                       onclick="law.goTarget('39')"><span>제39조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P40"
											                       onclick="law.goTarget('40')"><span>제40조</span> (급전선의
													차단)</a>
											</li>
											...
											<li class="comment"><a name="joMoveLink" href="#P43"
											                       onclick="law.goTarget('43')"><span>제43조</span> (전차선의
													기울기)</a>
											</li>
										</ul>
									</li>
									<li class="comment">
										...
										<ul>
											...
											<li class="comment"><a name="joMoveLink" href="#P46"
											                       onclick="law.goTarget('46')"><span>제46조</span> (통신설비의
													설치
													등)</a></li>
										</ul>
									</li>
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P47"
											                       onclick="law.goTarget('47')"><span>제47조</span> (본선
													열차의 신호방식)</a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P48"
											                       onclick="law.goTarget('48')"><span>제48조</span> (신호장치
													등의
													설치)</a></li>
									...
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P51"
											                       onclick="law.goTarget('51')"><span>제51조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P52"
											                       onclick="law.goTarget('52')"><span>제52조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P53"
											                       onclick="law.goTarget('53')"><span>제53조</span> </a>
											</li>
										</ul>
									</li>
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P54"
											                       onclick="law.goTarget('54')"><span>제54조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P55"
											                       onclick="law.goTarget('55')"><span>제55조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P56"
											                       onclick="law.goTarget('56')"><span>제56조</span> </a>
											</li>
										</ul>
									</li>
									<li class="comment">
										...
										<ul>
											<li class="comment"><a name="joMoveLink" href="#P57"
											                       onclick="law.goTarget('57')"><span>제57조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P58"
											                       onclick="law.goTarget('58')"><span>제58조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P59"
											                       onclick="law.goTarget('59')"><span>제59조</span> </a>
											</li>
											<li class="comment"><a name="joMoveLink" href="#P60"
											                       onclick="law.goTarget('60')"><span>제60조</span> </a>
											</li>
										</ul>
									</li>
								</ul>
				...
				<div class="ct-left-btn">
					<button id="btn-left-close" class="btn-div" onclick="fn_content_left_close()"><span
								class="icon icon-double-left icon-w20"></span></button>
					<button id="btn-left-open" class="btn-div" onclick="fn_content_left_open()"><span
				...
				<div class="ct-pw">
					<div class="border-b">
						<div class="btn_group law_funtion_btn">
							<a href="javascript:law.goToRefView('L000216E9101A2AB_0_L');"
							   class="btn on">3단비교<span class="icon icon-w15 icon-out-box ml-2"></span></a>
							<a href="javascript:law.goToRefView('L000216E9101A2AB_0_U');" id="rNewOldInfo"
							   class="btn">신구조문비교<span class="icon icon-w15 icon-out-box ml-2"></span></a>
							<a href="javascript:law.goToRefView('L000216E9101A2AB_0_B');" class="btn">법규비교<span
										class="icon icon-w15 icon-out-box ml-2"></span></a>
						</div>
					</div>
					<div class="border-b">
						<div class="ct-popup-btn-group btn_group law_funtion_btn">
							<button id="changed-clause-btn" class="btn" onclick="fn_ct_popup('changed-clause')"
							        disabled>변경조문
							</button>
							<button id="asterisk-form-btn" class="btn" onclick="fn_ct_popup('asterisk-form')">별표서식
							</button>
							<button id="revised-reasons-btn" class="btn" onclick="fn_ct_popup('revised-reasons')">
								제·개정이유
							</button>
							<button id="revised-sentence-btn" class="btn" onclick="fn_ct_popup('revised-sentence')">
								제·개정문
							</button>
							<button id="official-gazette-btn" class="btn" onclick="fn_ct_popup('official-gazette')">
								전자관보
							</button>
							<button id="official-correction-btn" class="btn"
							        onclick="fn_ct_popup('official-correction')">관보정정
							</button>
						</div>
						<a href="" class="btn-blue dis-b btn-l mt-20 box-shadow ta-c"><span>온주</span></a>
					</div>
					<div class="border-b">
						<h3 class="ct-tit">
							담당부처 전화번호
							<i class='icon-info' data-icon='' onmouseout="close_miju('T_lawTel_info')" onmouseover="open_miju('T_lawTel_info')">
								<span class='blind'>안내</span>
								<div id='T_lawTel_info' class='miju_box miju_box_left' style='right: auto; left: -100px;'>
									<div class='miju_box_line'>
										API를 통해 제공되는 정보로, 변경사항 발생 시 바로 반영되지 않을 수 있습니다.
									</div>
								</div>
							</i>
						</h3>
					...
					<div class="border-b">
						<div class="str">
							<h3 class="ct-tit">영문법령</h3>
							<div class="str-rt"><button class="btn-none btn-s" onclick="fn_popup_tab_on(this)" data-tab-id="#center-view-popup" data-tab-con='#result-D021'>전체보기</button></div>
						</div>
						<ul class="ul-dot link-list block-list mt-10">
							<li>
								<div class="dot-cell">
									<a href="" class="dis-b fs-14 c-blue">NO.16912, February 04, 2020</a>
								</div>
							</li>
							<li>
								<div class="dot-cell">
										...
										<li class="comment">
											...
											<ul>
												<li class="comment">
													...
													<a href="/Info/ContentView?sid=L000009994" class="popup_view">철도의 건설
														및
														철도시설
														유지관리에 관한 법률 시행규칙</a>
													<ul>
														<li class="comment close"><a
																	href="javascript:law.goToMapViewAll();"
					...
					<div class="border-b">
						<div class="str">
							<h3 class="ct-tit">입법동향</h3>
							<div class="str-rt"><a href="" class="btn-none btn-s">전체보기</a></div>
						</div>
						<ul class="link-list mt-10">
							<li>
								<span class="square-d-gray square-ls mr-2">계류</span>
								<a href="" class="fs-14 c-blue">[2208508] 폐기물관리법 일부개정법률안(대안)(환경노동위원장) </a>
								<span class="fs-14">[제안일 2023.7.28]</span>
							</li>
							<li>
								<span class="square-d-gray square-ls mr-2">계류</span>
								<a href="" class="fs-14 c-blue">[2208508] 폐기물관리법 일부개정법률안(대안)(환경노동위원장) </a>
	...
	<div class="ct-center">
		<div class="ct-pt h-100p">
				...
				<div class="ct-bg h-100p">
					<div class="ct-scroll ct-bg-pd">
						<div class="ct-title">
							<div class="dis-t w-100p">
								<div class="dis-tr">
									...
									<div class="dis-tc" style="width: 160px;">
										<select id="select" class="select-css02">
											<option>선택1</option>
											<option>선택2</option>
											<option>선택3</option>
											<option>선택4</option>
						...
						<div class="case_info highlighter-context" id="view_content" style="">
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_1"
							                           class="popup_view">제1조</a></em>(목적)
								...
								건설하는 도시철도의 건설기준 등에 관하여 필요한 사항을 규정함을 목적으로 한다. [개정 <span class="miju_num addition_num"
											...
											id="2014f7f8_8045" class="miju_box"> </div></span> 제106호(<a
										href="/Info/ContentView?sid=L000010555_0_20211103" class="popup_view">도시철도법
									시행규칙</a>)]<br>[전문개정
								<span
							...
							<a id="P2" name="P2"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_2"
							                           class="popup_view">제2조</a></em>(정의)
								...
								<br>이 규칙에서 사용하는 용어의 뜻은 다음과 같다. [개정 <span class="miju_num addition_num"
											...
											id="2021f8f27_2048" class="miju_box miju_box_left"><div
												class="miju_box_line"
								...
								“차량”이라 한다)의 경우: 레일의 맨 위쪽 부분으로부터 14밀리미터 아래 지점에 위치한 양쪽 레일의 안쪽 간의 가장 짧은 거리<br>나. 고무차륜을 사용하는
								차량의
								경우: 차륜 중심 간의 거리<br>다.
								자기부상추진방식을 사용하는 차량의 경우: 부상레일 중심 간의 거리<br>2. “본선(本線)”이란 열차의 운전에 상용(常用)되는 선로(정거장 안에 있는
								대피선과
								반복운전선을 포함한다)를
								말한다.<br>3. “측선(側線)”이란 본선 외의 선로를 말한다.<br>4. “정거장”이란 승객이 열차(본선에서 운행할 목적으로 편성된 차량을 말한다.
								이하
								같다)를 타고 내리는데 사용되는 장소를
								말한다.<br>5. “차량기지”란 차량을 유치·검수 및 정비 등을 하기 위하여 설치한 시설을 말한다.<br>6. “경량전철”이란 모노레일형식, 노면전차형식,
								철제차륜형식, 고무차륜형식,
								선형유도전동기형식, 자기부상추진형식 등으로 운행되고, 차량 최대 설계축하중 13.5톤 이하[분포하중(分布荷重)의 경우 단위 미터당 2.8톤 이하를
								말한다]의
								전기철도를 말한다.<br>7.
								“제3레일”이란 전차선(電車線)의 한 종류로서 레일 또는 주행면과 평행하게 부설하여 차량의 옆면이나 밑면에서 차량에 전기를 공급하는 시설물을
								말한다.<br>8.
								“제3레일방식”이란 제3레일을
								이용하여 차량에 전기를 공급하는 방식을 말한다.<br>[전문개정 <span class="miju_num addition_num"
								                                          onclick="open_miju('2010f10f8_2721')">2010.10.8<div
											id="2010f10f8_2721" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_2" style="" class="relative_law">
								<div id="J2_view" class="relative_law_view rules">_</div>
								<div class="detail_area">
									<div class="but" onclick="view.addBottomList('L000007101|2', 'L006','J2_view')">관련
										행정규칙
										<i
							...
							<a id="P3" name="P3"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_3"
							                           class="popup_view">제3조</a></em>(선로의
								형식)
								...
								<br>본선은 복선(複線)으로 한다. 다만, <a href="/Info/ContentView?sid=L000001751_6_20211103"
									...
									제6조</a>에 따른 노선별 도시철도기본계획에서 정하는 특수한 구간에 대해서는 단선(單線)으로 할 수 있다. [개정 <span
										...
										onclick="open_miju('2014f7f8_4192')">2014.7.8<div
											id="2014f7f8_4192" class="miju_box"> </div></span> 제106호(<a
										href="/Info/ContentView?sid=L000010555_0_20211103" class="popup_view">도시철도법
									시행규칙</a>)]<br>[전문개정
								<span
							...
							<a id="P4" name="P4"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_4"
							                           class="popup_view">제4조</a></em>
								...
								<br> 삭제 [<span class="miju_num addition_num" onclick="open_miju('2004f12f4_7435')">2004.12.4<div
											id="2004f12f4_7435" class="miju_box"> </div></span>]
								[[시행일 2005.3.4]]
							</div>
							<div id="I_4" style="display:none;" class="relative_law">_</div>
							<a id="P5" name="P5"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_5"
							                           class="popup_view">제5조</a></em>(열차의
								운전
								진로)
								<div class="btn-group  " style="display:none;" id="R_5">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>상행·하행 열차를 구별하여 운전하는 한 쌍의 선로의 경우 열차의 운전 진로는 오른쪽으로 한다. 다만, 국유철도와 직접 연결되는 선로의 경우에는 왼쪽으로
								할 수
								있다.<br>[전문개정 <span
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_6"
							                           class="popup_view">제6조</a></em>(궤간)
							...
							<a id="P7" name="P7"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_7"
							                           class="popup_view">제7조</a></em>(확대궤간)
								<div class="btn-group  " style="display:none;" id="R_7">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 선로가 곡선인 구간(이하 “곡선구간”라 한다)의 궤간에는 <a
										href="/Info/ContentView?sid=L000007101_6_20211103"
										class="popup_view">제6조</a>에도
								불구하고 확대궤간을 두어야 한다.<br> ② 제1항에 따른 확대궤간은 곡선부분의 안쪽 레일에 두어야 하며, 그 치수는 25밀리미터를 초과하지 아니하는 범위에서
								해당
								곡선의 반경 등을 고려하여
								특별시장·광역시장·도지사·특별자치도지사·시장 또는 군수(이하 “시·도지사등”이라 한다)가 정한다.<br>[전문개정 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_2883')">2010.10.8<div
											id="2010f10f8_2883" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_7" style="display:none;" class="relative_law">_</div>
							<a id="P8" name="P8"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_8"
							                           class="popup_view">제8조</a></em>(확대궤간의
								체감거리)
								<div class="btn-group  " style="display:none;" id="R_8">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① <a href="/Info/ContentView?sid=L000007101_7_20211103" class="popup_view">제7조</a>에
								따른
								확대궤간은 선로가 나누어지는 지점(이하
								“분기부”라 한다)의 경우를 제외하고는 다음 각 호의 거리에서 체감(遞減)시켜야 한다.<br> 1. 완화곡선이 있는 경우: 그 곡선 전체의 거리<br>
								2.
								완화곡선이 없는 경우: <a
										href="/Info/ContentView?sid=L000007101_12_20211103" class="popup_view">제12조</a>에
								따른
								캔트의 체감거리(遞減距離)와
								같게 하되, 캔트를 두지 아니하는 경우에는 원곡선의 시작점·끝점으로부터 5미터 이상의 거리<br> ② 반경이 다른 같은 방향의 곡선이 접속하는 경우에는 반경이
								큰
								곡선 안에서 확대궤간의 차를
								제1항제1호 및 제2호에 준하여 체감하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
								                                           onclick="open_miju('2010f10f8_986')">2010.10.8<div
											id="2010f10f8_986" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_8" style="display:none;" class="relative_law">_</div>
							<a id="P9" name="P9"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_9"
							                           class="popup_view">제9조</a></em>(궤간의
								공차)
								<div class="btn-group  " style="display:none;" id="R_9">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 궤간에는 다음 각 호에서 정하는 공차(公差)를 허용한다.<br> 1. 크로싱의 경우: 증(增) 3밀리미터, 감(減) 2밀리미터<br> 2.
								그 밖의
								경우: 증 10밀리미터, 감
								2밀리미터<br> ② 제1항에 따른 허용치에 확대궤간을 더한 치수는 30밀리미터를 초과해서는 아니 된다.<br>[전문개정 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_4021')">2010.10.8<div
											id="2010f10f8_4021" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_10"
							                           class="popup_view">제10조</a></em>(선로의
								곡선반경 등)
							...
							<a id="P11" name="P11"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_11"
							                           class="popup_view">제11조</a></em>(캔트)
								<div class="btn-group  " style="display:none;" id="R_11">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 곡선구간의 바깥쪽 레일에는 열차의 안전운행을 위하여 캔트(열차의 원심력에 의한 탈선이나 전복을 막기 위하여 바깥쪽 레일을 안쪽 레일보다 높게
								부설하는 것을
								말한다. 이하 같다)를 두어야
								...
								초과할 수 없다.<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_6598" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_11" style="display:none;" class="relative_law">_</div>
							<a id="P12" name="P12"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_12"
							                           class="popup_view">제12조</a></em>(캔트의
								체감거리)
								<div class="btn-group  " style="display:none;" id="R_12">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>캔트의 체감거리는 다음 각 호와 같다.<br> 1. 완화곡선이 있는 경우: 그 곡선 전체의 거리<br> 2. 완화곡선이 없는 경우: <a
										href="/Info/ContentView?sid=L000007101_11_20211103"
										class="popup_view">제11조제2항</a>에
								따른 캔트(이하 “표준캔트”로
								...
								부득이한 경우: 표준캔트의 450배 이상의 거리<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_2642" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_12" style="display:none;" class="relative_law">_</div>
							<a id="P13" name="P13"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_13"
							                           class="popup_view">제13조</a></em>(완화곡선)
								<div class="btn-group  " style="display:none;" id="R_13">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 본선의 경우에 곡선반경이 800미터 이하인 곡선과 직선이 접속하는 곳에는 적절한 완화곡선을 삽입하여야 한다. 다만, 분기부에 연속되는 곡선인
								경우에는
								그러하지 아니하다.<br> ② 제1항에
							...
							<a id="P14" name="P14"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_14"
							                           class="popup_view">제14조</a></em>(직선의
								삽입
								등)
								<div class="btn-group  " style="display:none;" id="R_14">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 본선의 경우에 인접하여 두 개의 곡선이 있는 선로에는 캔트 체감 후에 20미터 이상의 직선을 삽입하여야 한다.<br> ② 제1항의 경우에 반대방향의
								두
								개의 곡선인 선로가 인접되어 있는
								경우로서 지형상 직선을 삽입할 수 없는 부득이한 때에는 직선을 삽입하지 아니할 수 있으며, 같은 방향의 두 개의 곡선인 선로가 인접되어 있는 경우에는
								시·도지사등이
								정하는 범위에서 복심곡선으로 할 수
								있다.<br> ③ 제1항 및 제2항에도 불구하고 분기부에 연속하는 경우와 측선의 경우로서 안전에 지장이 없는 경우에는 직선을 삽입하지 아니하거나 제2항의
								기준과 다른
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_15"
							                           class="popup_view">제15조</a></em>(정거장
								밖의
								기울기한도)
								<div class="btn-group  " style="display:none;" id="R_15">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 정거장 밖의 지역에 있는 본선의 기울기는 1천분의 35를 초과해서는 아니 된다.<br> ② 곡선인 선로에 기울기를 두는 경우에는 제1항에 따른
								한도에
								적절한 곡선보정을 한 기울기를 한도로
								한다.<br>[전문개정 <span class="miju_num addition_num" onclick="open_miju('2010f10f8_8064')">2010.10.8<div
											id="2010f10f8_8064" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_15" style="display:none;" class="relative_law">_</div>
							<a id="P16" name="P16"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_16"
							                           class="popup_view">제16조</a></em>(정거장
								안의
								기울기 한도)
								<div class="btn-group  " style="display:none;" id="R_16">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>정거장 안에 있는 본선의 기울기는 다음 각 호의 구분에 따른 한도를 초과해서는 아니 된다.<br> 1. 본선이 차량을 분리·연결 또는 유치하는 용도로
								사용되는
								경우: 1천분의 3<br> 2.
								제1호 외의 경우: 1천분의 8(부득이한 경우에는 1천분의 10)<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_5549" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_16" style="display:none;" class="relative_law">_</div>
							<a id="P17" name="P17"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_17"
							                           class="popup_view">제17조</a></em>(측선의
								기울기)
							...
							<a id="P18" name="P18"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_18"
							                           class="popup_view">제18조</a></em>(종곡선)
								<div class="btn-group  " style="display:none;" id="R_18">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>선로의 기울기가 변하는 경우로서 인접 기울기의 변화가 1천분의 5를 초과하는 경우에는 반경 3천미터 이상의 종곡선(從曲線)을 삽입하여야
								한다.<br>[전문개정
								<span
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_19"
							                           class="popup_view">제19조</a></em>(건축한계)
								<div class="btn-group  " style="display:none;" id="R_19">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>도시철도에는 차량의 흔들림이나 선로의 비틀림 등을 고려하여 차량의 안전운행에 필요한 공간(이하 “건축한계”라 한다)을 두고 이에 건물이나 그 밖의
								시설을
								설치해서는 아니 된다. 다만,
								가공전차선(架空電車線) 및 그 현수장치(懸垂裝置)와 선로 보수 등의 작업에 필요한 일시적인 시설로서 열차의 안전운행에 지장이 없는 경우에는
								그러하지
								아니하다.<br>[전문개정 <span
							...
							<a id="P20" name="P20"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_20"
							                           class="popup_view">제20조</a></em>(직선구간의
								건축한계)
								...
								<br>선로가 직선인 구간(이하 “직선구간”라 한다)의 건축한계는 시·도지사등이 정한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_3137')">2010.10.8<div
											id="2010f10f8_3137" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_20" style="display:none;" class="relative_law">_</div>
							<a id="P21" name="P21"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_21"
							                           class="popup_view">제21조</a></em>(곡선구간의
								건축한계)
								<div class="btn-group  " style="display:none;" id="R_21">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 곡선구간의 건축한계는 <a href="/Info/ContentView?sid=L000007101_11_20211103"
								                     class="popup_view">제11조제2항</a>에
								따른 캔트의
								크기에 따라 기울게 하여야 한다.<br> ② 제1항에 따른 곡선구간의 건축한계는 직선구간의 건축한계를 궤도중심의 각 측(側)에 일정한 치수 이상으로 확대한
								것으로
								하되, 그 범위는 곡선반경 등을
								고려하여 시·도지사등이 정한다. 다만, 가공전차선 및 그 현수장치를 제외한 상부의 건축한계는 이에 따르지 아니할 수 있다.<br> ③ 제2항에 따른 확대치수는
								완화곡선에 따라 체감하여야 한다. 다만,
								완화곡선의 길이가 20미터 이하인 경우 또는 완화곡선이 없는 경우에는 원곡선 끝으로부터 20미터 이상의 거리에서 체감하여야 하며, 원곡선이 복심곡선인 경우
								확대치수의
								차는 반경이 큰 곡선으로부터
								20미터 이상의 거리에서 체감하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
								                                       onclick="open_miju('2010f10f8_5020')">2010.10.8<div
											id="2010f10f8_5020" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_22"
							                           class="popup_view">제22조</a></em>(궤도의
								중심
								간격)
								<div class="btn-group  " style="display:none;" id="R_22">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 열차가 서로 반대방향으로 운행되는 본선 궤도의 경우에는 열차 및 승객 등의 안전을 위하여 궤도 간의 간격을 충분히 두어야 한다.<br> ② 제1항에
								따른
								궤도의 간격은 해당 궤도의 지상부,
								지하부, 궤도 병설 수 및 차체규격 등을 고려하여 시·도지사등이 기준을 정한다. 이 경우 궤도 사이에 가공전차선 지주(支柱)나 신호기 지주 등을 설치하는
								경우에는
								해당 부분만큼 궤도의 간격을
								확대하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
								                         onclick="open_miju('2010f10f8_824')">2010.10.8<div
											id="2010f10f8_824" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_22" style="display:none;" class="relative_law">_</div>
							<a id="P23" name="P23"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_23"
							                           class="popup_view">제23조</a></em>(곡선인
								궤도의
								중심 간격)
								...
								두 배 이상으로 확대하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_4520" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_23" style="display:none;" class="relative_law">_</div>
							<a id="P24" name="P24"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_24"
							                           class="popup_view">제24조</a></em>(레일)
								...
								<br>레일의 중량은 열차의 종류, 설계하중 및 통과톤수 등에 따라 시·도지사등이 정한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_8700')">2010.10.8<div
											id="2010f10f8_8700" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_24" style="display:none;" class="relative_law">_</div>
							<a id="P25" name="P25"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_25"
							                           class="popup_view">제25조</a></em>(도상의
								두께
								등)
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_26"
							                           class="popup_view">제26조</a></em>(건축한계
								외의
								여유 공간)
							...
							<a id="P27" name="P27"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_27"
							                           class="popup_view">제27조</a></em>(도로면
								등으로부터의 간격)
								<div class="btn-group  " style="display:none;" id="R_27">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 도로면과 지하구조물 윗면과의 사이 또는 도로면과 고가구조물 밑면과의 사이에는 안전 확보와 통신·배관 등 지하매설물이나 지상가설물의 설치 등에 필요한
								일정
								기준 이상의 깊이 또는 높이를
								확보하여야 한다. 다만, 개구부(開口部) 등 지형상 부득이한 경우로서 안전에 지장이 없다고 인정되는 경우에는 그러하지 아니하다.<br> ② 제1항에 따른
								깊이
								또는 높이의 기준은 지질 등을
								고려하여 시·도지사등이 정한다.<br> ③ 하천의 밑을 지나는 터널의 윗면과 하천의 계획준설면 사이에는 하천의 유지·관리 및 도시철도 시설물의 보호 등을
								위하여
								시·도지사등이 정하는 기준 이상의 깊이를
								확보하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
								                         onclick="open_miju('2010f10f8_7386')">2010.10.8<div
											id="2010f10f8_7386" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_27" style="display:none;" class="relative_law">_</div>
							<a id="P28" name="P28"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_28"
							                           class="popup_view">제28조</a></em>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_29"
							                           class="popup_view">제29조</a></em>(분기)
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_30"
							                           class="popup_view">제30조</a></em>(정거장의
								시설ㆍ설비)
								...
								<span class="miju_num addition_num" onclick="open_miju('2013f3f23_4595')">2013.3.23<div
											...
											class="miju_box"
									> </div></span>
								제1호(<a href="/Info/ContentView?sid=L000011804_0_20211103" class="popup_view">국토교통부와 그
									소속기관
									직제 시행규칙</a>)]<br>[전문개정
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_30X2"
								...
								<br>① 승강장에는 승객의 안전사고를 방지하기 위하여 다음 각 호의 어느 하나에 해당하는 안전시설을 설치해야 한다. [개정 <span
										...
										onclick="open_miju('2021f8f27_9308')">2021.8.27<div
											id="2021f8f27_9308" class="miju_box"> </div></span>
								...
								스크린도어의 재질은 <a
										href="/Info/ContentView?sid=L000007104_10_20211103" class="popup_view">「도시철도차량
									안전기준에
									관한 규칙」 제10조제1항</a>에
								따른 불연재료 또는 같은 조 제3항에 따른 재료를 사용할 것<br>4. 화재 발생 등 비상 상황이 발생하는 경우 손으로 출입문을 열 수 있도록 할 것<br>5.
								승강장의 구조와 승강장의 바닥구조물의
								강도를 고려하여 설치할 것<br>③ 차량과 승강장 연단의 간격이 10센티미터가 넘는 부분에는 안전발판 등 승객의 실족사고를 방지하는 설비를 설치하여야
								한다.<br>[전문개정
								<span
							...
							<a id="P31" name="P31"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_31"
							                           class="popup_view">제31조</a></em>(승강장의
								너비
								등)
								<div class="btn-group  " style="display:none;" id="R_31">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 승강장의 너비는 다음 각 호의 기준에 따른다. 다만, 승객의 이용이 적은 승강장의 양 끝 지역이나 승강장의 구조 등을 고려하여 국토교통부장관이
								고시하는
								경우에는 승강장의 너비를 다음 각 호의
								기준보다 좁게 할 수 있다. [개정 <span class="miju_num addition_num"
								                          onclick="open_miju('2021f11f3_7633')">2021.11.3<div
											id="2021f11f3_7633" class="miju_box"> </div></span>]<br>1.
								본선과 본선 사이에 설치된
								승강장의 경우: 8미터 이상<br>2. 본선의 양옆에 설치된 승강장의 경우: 4미터 이상<br>② 승강장의 연단으로부터 너비 1.5미터, 높이 2미터 이내에는
								승객의
								실족·추락 방지시설, 대피시설 등
								안전시설만을 설치할 수 있다. 다만, 시·도지사등은 해당 승강장의 여건상 불가피하다고 인정되는 경우에는 기둥이나 계단 또는 <a
									...
									시행령」 제3조</a>에 따른 승강기를
								설치하게 할 수 있다. [개정 <span class="miju_num addition_num"
								                       onclick="open_miju('2021f11f3_2240')">2021.11.3<div
											id="2021f11f3_2240" class="miju_box"> </div></span>]<br>③
								삭제 [<span
							...
							<a id="P32" name="P32"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_32"
							                           class="popup_view">제32조</a></em>(승강장
								연단의
								높이)
								...
								<br>승강장의 연단은 레일의 윗면으로부터 1.135미터 높이에 설치하는 것을 표준으로 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_4665')">2010.10.8<div
											id="2010f10f8_4665" class="miju_box"> </div></span>]
							</div>
							<div id="I_32" style="display:none;" class="relative_law">_</div>
							<a id="P33" name="P33"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_33"
							                           class="popup_view">제33조</a></em>(승강장
								연단과
								차량한계와의 간격)
								<div class="btn-group  " style="display:none;" id="R_33">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 승강장의 연단은 <a href="/Info/ContentView?sid=L000007101_51_20211103"
								                  class="popup_view">제51조</a>에
								따른 차량한계로부터
								50밀리미터의 간격을 두고 설치하여야 한다.<br> ② 선로가 곡선으로 되어 있는 승강장은 제1항에 따른 간격에 <a
										href="/Info/ContentView?sid=L000007101_21_20211103"
										class="popup_view">제21조제2항</a>에
							...
							<a id="P34" name="P34"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_34"
							                           class="popup_view">제34조</a></em>(승강장의
								길이
								및 통로의 폭)
								<div class="btn-group  " style="display:none;" id="R_34">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>승강장의 유효길이 및 통로의 폭은 해당 노선의 수송수요 및 운전계획 등을 고려하여 정하되, 이에 필요한 세부적인 사항은 국토교통부장관이 정하여
								고시한다.
								[개정 <span
							...
							<a id="P35" name="P35"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_35"
							                           class="popup_view">제35조</a></em>(노면
								출입구
								및 지상보행로)
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_35X2"
								...
								<br>① 지하 3층 이하의 승강장에는 비상시 승객이 쉽게 대피할 수 있도록 승강장과 지상을 계단으로 직접 연결한 별도의 비상계단(이하 “특별피난계단”이라
								한다)을
								설치하되, 본선과 본선 사이에 설치된
								승강장에는 한 군데 이상, 본선의 양옆에 설치된 승강장에는 승강장별로 한 군데 이상을 설치하여야 한다.<br> ② 제1항에 따라 특별피난계단을 설치하는 경우
								<a
										href="/Info/ContentView?sid=L000007101_69_20211103" class="popup_view">제69조</a>에
								따른
								유도등과 <a
										href="/Info/ContentView?sid=L000007101_70_20211103" class="popup_view">제70조</a>에
								따른
								비상조명등을 각각 설치하여야
								한다.<br>[전문개정 <span class="miju_num addition_num" onclick="open_miju('2010f10f8_810')">2010.10.8<div
											id="2010f10f8_810" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_35X3"
								...
								있다.<br> 2. 복도·계단 및 통로에
								사용되는 마감재료는 불연재료를 사용하여야 한다.<br> 3. 조립식 칸막이의 외부에 사용되는 마감재료는 불연재료를 사용하여야 하며, 조립식 칸막이의 내부에
								사용되는
								재료는 불연재료 또는 <a
										href="/Info/ContentView?sid=L000002118_2_20211103" class="popup_view">「건축법 시행령」
								...
								정거장 구조물의 균열·누수 또는 노후화를 쉽게 점검할 수 있도록 적절한 방법에 따라 설치하여야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_4929')">2010.10.8<div
											id="2010f10f8_4929" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_36"
							                           class="popup_view">제36조</a></em>(전기방식)
								...
								한다.<br> 1. 전차선로: 직류
								1천500볼트 가공선식(架空線式)<br> 2. 고압배전선: 교류 3상 6천600볼트, 2만2천볼트 또는 2만2천900볼트<br> 3. 선로 안의 조명
								및
								동력시설: 교류 단상(單相)
								220볼트 또는 3상 380볼트<br> 4. 신호용 배전선: 교류 100볼트 이상 400볼트 이하<br>[전문개정 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_4003')">2010.10.8<div
											id="2010f10f8_4003" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_36" style="display:none;" class="relative_law">_</div>
							<a id="P37" name="P37"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_37"
							                           class="popup_view">제37조</a></em>(전선로)
								<div class="btn-group  " style="display:none;" id="R_37">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 조명 및 동력용 고압배전선은 2회선 이상으로 하여야 한다.<br> ② 지상부 전차선은 별도의 급전선(給電線)을 설치하여 구간별로 전기를
								공급하여야
								하고, 지하부 전차선은
								강체전차선(剛體電車線) 또는 커티너리 조가선(弔架線)이 급전선을 겸하도록 하여야 한다. 다만, 제3레일방식의 경우에는 제3레일이 급전선을
								겸하도록
								하여야 한다.<br>[전문개정 <span
							...
							<a id="P38" name="P38"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_38"
							                           class="popup_view">제38조</a></em>(전식방지대책)
								<div class="btn-group  " style="display:none;" id="R_38">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>주행레일을 귀선(歸線)으로 이용하는 경우에는 누설전류에 의하여 케이블, 금속제 지중관로 및 선로 구조물 등에 미칠 장애를 방지하기 위한 적절한
								시설을
								설치하여야 한다.<br>[전문개정
							...
							<a id="P39" name="P39"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_39"
							                           class="popup_view">제39조</a></em>
								...
								<br> 삭제 [<span class="miju_num addition_num" onclick="open_miju('2004f12f4_6711')">2004.12.4<div
											id="2004f12f4_6711" class="miju_box"> </div></span>]
								[[시행일 2005.3.4]]
							</div>
							<div id="I_39" style="display:none;" class="relative_law">_</div>
							<a id="P40" name="P40"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_40"
							                           class="popup_view">제40조</a></em>(급전선의
								차단)
								...
								<br>급전선에 설치하는 자동차단설비는 사고 등의 비상시에 신속히 사고전류를 검지하여 전원을 차단할 수 있어야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_3451')">2010.10.8<div
											id="2010f10f8_3451" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_40" style="display:none;" class="relative_law">_</div>
							<a id="P41" name="P41"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_41"
							                           class="popup_view">제41조</a></em>(예비전원설비)
								<div class="btn-group  " style="display:none;" id="R_41">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>지하선로에는 예비전원설비 또는 2중계 이상의 공급선로를 설치하여야 한다.<br>[전문개정 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_5636')">2010.10.8<div
											id="2010f10f8_5636" class="miju_box"> </div></span>]
							</div>
							<div id="I_41" style="display:none;" class="relative_law">_</div>
							<a id="P42" name="P42"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_42"
							                           class="popup_view">제42조</a></em>(전차선로)
								...
								경계지점, 변전소 부근 등 보안 및 운전에 필요한 곳에서는 전기 공급이 자동으로 차단될 수 있도록 급단전(給斷電) 설비를 갖추어야 한다.<br> ③
								전차선이
								제3레일방식인 경우에는
								승강장·궤도·차량기지 등에 승객·승무원·역무원·보수점검원 등이 고압에 감전되는 위험을 최소화할 수 있도록 적절한 설비를 갖추어야 한다.<br>[전문개정
								<span
							...
							<a id="P43" name="P43"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_43"
							                           class="popup_view">제43조</a></em>(전차선의
								기울기)
								<div class="btn-group  " style="display:none;" id="R_43">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>가공전차선의 레일면에 대한 기울기는 본선의 경우에는 1천분의 3 이하로 하고, 측선의 경우에는 1천분의 10 이하로 하여야 한다. 다만, 지형상
								부득이한 경우
								본선의 경우에는 1천분의 5 이하로
								할 수 있고, 측선의 경우에는 1천분의 15 이하로 할 수 있다.<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_5978" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_44"
							                           class="popup_view">제44조</a></em>(환기설비)
								...
								<br>지하선로에는 지하 공간의 크기, 도시철도의 운행계획, 이용객의 편익 등을 고려하여 적절한 환기설비를 하여야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_1923')">2010.10.8<div
											id="2010f10f8_1923" class="miju_box"> </div></span>]
							</div>
							<div id="I_44" style="display:none;" class="relative_law">_</div>
							<a id="P45" name="P45"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_45"
							                           class="popup_view">제45조</a></em>(배수설비)
							...
							<a id="P46" name="P46"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_46"
							                           class="popup_view">제46조</a></em>(통신설비의
								설치 등)
								<div class="btn-group  " style="display:none;" id="R_46">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 통신설비는 열차의 운행과 시설물의 운용 및 유지·관리에 지장이 없도록 설치하여야 한다.<br> ② 무선통신설비는 승무원·역무원·보수원 및 관제
								업무에
								종사하는 사람 등 도시철도 관련 업무에
								종사하는 사람 간에 양방향 통신을 할 수 있고, 도시철도 관련 업무에 종사하는 사람과 경찰서·소방서·의료기관 등 외부 재난 관련 기관과도 양방향 통신을 할 수
								있도록
								설치하여야 한다.<br> ③
								관제실과 역무실에는 승강장, 대합실 등의 안전이 취약한 장소의 상황을 화상을 통하여 실시간으로 감시할 수 있는 설비를 설치하여야 한다.<br> ④ 역무실에는
								화재경보가 감지된 지역을 화상으로 나타낼 수
								있는 설비를 설치하여야 한다.<br> ⑤ 운전실에는 차량이 승강장에 진입하여 정차한 후 출발할 때까지의 승강장 상황을 화상을 통하여 실시간으로 감시할 수 있는
								설비를
								설치하여야 한다. 다만, 역사
								전체에 스크린도어가 설치되어 있거나 <a href="/Info/ContentView?sid=L000007102_3_20211103"
								                       class="popup_view">「도시철도운전규칙」
									제3조제11호</a>에 따른 무인운전을 적용하는 경우에는 그러하지 아니하다.<br> ⑥ 승강장에는 승객이 역무실과 양방향 통화를 할 수 있는
								비상통신장치를
								승강장의 바닥에서 1.5미터 높이로 세
								군데 이상의 장소에 분산하여 설치하여야 한다.<br> ⑦ 제2항에 따른 무선통신설비를 이용한 음성통화 내용은 녹음장치에 녹음하여 1개월 이상 보관하고,
								제3항에 따른
								화상기록은 녹화장치에 녹화하여
								1주일 이상 보관하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
								                                onclick="open_miju('2010f10f8_7236')">2010.10.8<div
											id="2010f10f8_7236" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_47"
							                           class="popup_view">제47조</a></em>(본선
								열차의
								신호방식)
							...
							<a id="P48" name="P48"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_48"
							                           class="popup_view">제48조</a></em>(신호장치
								등의
								설치)
								...
								<br>분기부가 설치된 정거장이나 차량기지 등에는 차량의 입환(入換)에 필요한 신호장치와 진로표지를 설치하여야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_4411')">2010.10.8<div
											id="2010f10f8_4411" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_48" style="display:none;" class="relative_law">_</div>
							<a id="P49" name="P49"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_49"
							                           class="popup_view">제49조</a></em>(선로전환기와
								신호장치와의 연동)
								...
								<br>선로의 진로를 변경시키는 선로전환기와 열차의 진행방향을 안내하는 신호장치는 서로 연동되도록 설치하여야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_4984')">2010.10.8<div
											id="2010f10f8_4984" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_49" style="display:none;" class="relative_law">_</div>
							<a id="P50" name="P50"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_50"
							                           class="popup_view">제50조</a></em>(보안장치)
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_50X2"
								...
								가능하도록 설치하여야 한다.<br>[본조신설 <span class="miju_num addition_num"
											...
											id="2010f10f8_1303" class="miju_box"> </div></span>]<br>
							</div>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_51"
							                           class="popup_view">제51조</a></em>
							...
							<a id="P52" name="P52"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_52"
							                           class="popup_view">제52조</a></em>
							...
							<a id="P53" name="P53"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_53"
							                           class="popup_view">제53조</a></em>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_54"
							                           class="popup_view">제54조</a></em>
							...
							<a id="P55" name="P55"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_55"
							                           class="popup_view">제55조</a></em>
							...
							<a id="P56" name="P56"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_56"
							                           class="popup_view">제56조</a></em>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_57"
							                           class="popup_view">제57조</a></em>
							...
							<a id="P58" name="P58"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_58"
							                           class="popup_view">제58조</a></em>
							...
							<a id="P59" name="P59"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_59"
							                           class="popup_view">제59조</a></em>
							...
							<a id="P60" name="P60"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_60"
							                           class="popup_view">제60조</a></em>
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_61"
							                           class="popup_view">제61조</a></em>(선로의
								표지)
								<div class="btn-group  " style="display:none;" id="R_61">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>선로에는 다음 각 호의 표지를 설치하여야 한다.<br> 1. 100미터 구간마다 그 거리를 표시하는 표지<br> 2. 기울기가 변경되는 장소에는 그
								기울기를
								표시하는 표지<br> 3. 분기부에는
								차량의 접속한계를 표시하는 표지<br> 4. 곡선의 반경 및 시작점·끝점과 완화곡선의 시작점·끝점을 표시하는 표지<br> 5. 열차속도를 제한하거나 그 밖에
								전기 및
								열차의 운행상 특히 주의하여야 할
								곳에는 이를 표시하는 표지<br> 6. 정거장의 중심을 표시하는 표지<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_8280" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_61" style="display:none;" class="relative_law">_</div>
							<a id="P62" name="P62"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_62"
							                           class="popup_view">제62조</a></em>(차막이시설)
							...
							<a id="P63" name="P63"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_63"
							                           class="popup_view">제63조</a></em>(대피시설)
							...
							<a id="P64" name="P64"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_64"
							                           class="popup_view">제64조</a></em>(침수방지설비)
							...
							<a id="P65" name="P65"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_65"
							                           class="popup_view">제65조</a></em>(방화설비
								및
								방재설비)
								...
								<br>구조물에는 방화설비 및 방재설비를 하여야 한다.<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_5773" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_65" style="display:none;" class="relative_law">_</div>
							<a id="P66" name="P66"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_66"
							                           class="popup_view">제66조</a></em>(환기구
								내부의
								설비)
								...
								<br>환기구 내부에는 출입이 쉽도록 계단이나 사다리 등의 장치를 하여야 하며, 안전에 필요한 철책을 설치하여야 한다.<br>[전문개정 <span
										...
										onclick="open_miju('2010f10f8_538')">2010.10.8<div
											id="2010f10f8_538" class="miju_box"> </div></span>]
							</div>
							<div id="I_66" style="display:none;" class="relative_law">_</div>
							<a id="P67" name="P67"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_67"
							                           class="popup_view">제67조</a></em>(제연설비)
								<div class="btn-group  " style="display:none;" id="R_67">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 정거장 및 터널 안에는 화재가 발생할 경우 승객이 쉽게 대피할 수 있도록 화재 발생 장소를 고려하여 유독가스 배출방향을 조절할 수 있는
								제연(制煙)설비를
								설치하여야 한다.<br> ②
								제연설비 중 전동기·배풍기·배출풍도 및 배풍막(배풍기와 배출풍도를 연결하는 막을 말한다)은 섭씨 250도에서 1시간 이상 정상적으로 기능을 유지할 수 있어야
								한다.
								다만, 배풍기와 분리 설치되어
								배출가스의 영향을 받지 아니하는 전동기의 경우에는 그러하지 아니하다.<br> ③ 터널 안에 설치하는 제연설비는 승객이 대피하는 반대방향으로 연기가 배출될 수
								있도록
								연기의 배출방향을 조절할 수 있는
								성능을 갖추어야 하며, 비상시 배출되는 연기의 기류속도는 초속 2.5미터 이상이 되도록 하여야 한다.<br> ④ 특별피난계단의 승강장 쪽 입구와 승강장에서
								대합실로
								통하는 계단 또는 에스컬레이터의
								입구에는 제연 경계벽 등 유독가스의 확산을 지연시키거나 방지하는 설비를 각각 설치하여야 한다.<br>[전문개정 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_1263')">2010.10.8<div
											id="2010f10f8_1263" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_67" style="display:none;" class="relative_law">_</div>
							<a id="P68" name="P68"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_68"
							                           class="popup_view">제68조</a></em>(물을
								사용하는
								소화설비)
								<div class="btn-group  " style="display:none;" id="R_68">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>정거장에 설치하는 옥내소화전, 살수장치(sprinkler) 등 물을 사용하는 소화설비는 전기 공급이 중단된 때에도 작동할 수 있도록 상수도
								소화용수설비와
							...
							<a id="P69" name="P69"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_69"
							                           class="popup_view">제69조</a></em>(유도등)
								...
								② 정거장 안의 주요 대피로에는
								비상시 청각장애인이 쉽게 대피할 수 있도록 점멸(點滅)기능을 가진 유도등을 설치하거나 유도등의 인근에 시각경보기를 설치하여야 한다.<br>[전문개정
								<span
							...
							<a id="P70" name="P70"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_70"
							                           class="popup_view">제70조</a></em>(비상조명등)
								...
								5럭스(lux) 이상이 되도록 하여야 한다.<br> ③ 터널 안의 비상조명등은 바닥으로부터 1미터 이상 1.5미터 이하의 높이에 설치하고, 바닥의 평균조명도가
								1럭스
							...
							<a id="P71" name="P71"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_71"
							                           class="popup_view">제71조</a></em>(터널
								안의
								연결송수관설비 등)
								<div class="btn-group  " style="display:none;" id="R_71">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① 터널 안에는 비상시 소화용으로 활용할 수 있도록 연결송수관설비를 설치하여야 하며, 방수구(防水口)는 터널의 동일 선로 연결방향으로 50미터
								이내의
								간격으로 설치하여야 한다.<br> ②
								제1항에 따른 연결송수관설비는 평상시에는 터널 안 살수용으로 활용할 수 있다.<br>[전문개정 <span class="miju_num addition_num"
											...
											id="2010f10f8_370" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_71" style="display:none;" class="relative_law">_</div>
							<a id="P72" name="P72"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_72"
							                           class="popup_view">제72조</a></em>(터널로
								통하는
								진입로)
								<div class="btn-group  " style="display:none;" id="R_72">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>승강장에서 터널로 통하는 진입로는 너비가 90센티미터 이상이 되어야 하며, 비상시 승객이 쉽게 대피할 수 있도록 계단 등 안전시설을 설치하여야
								한다.<br>[전문개정
								<span
							...
							<a id="P73" name="P73"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_73"
							                           class="popup_view">제73조</a></em>(내진설계기준)
								...
								내진설계기준은 국토교통부장관이 정하여 고시한다. [개정 <span class="miju_num addition_num"
											...
											id="2013f3f23_3446" class="miju_box"> </div></span>
								제1호(<a
										href="/Info/ContentView?sid=L000011804_0_20211103" class="popup_view">국토교통부와 그
									소속기관
									직제 시행규칙</a>)]<br>[전문개정
							...
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_74"
							                           class="popup_view">제74조</a></em>(궤간에
								관한
								특례)
								...
								경우 궤간의 치수는 1천435밀리미터를 표준으로 하고, 고무차륜을 사용하는 경우 궤간의 치수는 1천700밀리미터, 안내면 간 거리(차량의 궤도 이탈을 막는
								안내레일
								안쪽 간의 거리 중 가장 짧은 거리를
								말한다)의 치수는 2천900밀리미터를 표준으로 한다. 그 밖에 다른 형식의 경우 궤간은 차량의 구조, 궤도 등의 특성을 고려하여 시·도지사등이 정한다.<br>
								②
								<a
										href="/Info/ContentView?sid=L000007101_9_20211103" class="popup_view">제9조</a>에도
								불구하고
								경량전철 궤간의 공차는 차량의 형식
								및 궤도의 특성을 고려하여 시·도지사등이 정한다.<br>[본조신설 <span class="miju_num addition_num"
								                                           onclick="open_miju('2010f10f8_2853')">2010.10.8<div
											id="2010f10f8_2853" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_74" style="display:none;" class="relative_law">_</div>
							<a id="P75" name="P75"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_75"
							                           class="popup_view">제75조</a></em>(확대궤간에
								관한 특례)
								<div class="btn-group  " style="display:none;" id="R_75">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br>① <a href="/Info/ContentView?sid=L000007101_7_20211103" class="popup_view">제7조</a> 및
								<a
										href="/Info/ContentView?sid=L000007101_8_20211103" class="popup_view">제8조</a>에도
								불구하고
								경량전철 확대궤간의 치수 및
							...
							<a id="P76" name="P76"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_76"
							                           class="popup_view">제76조</a></em>(캔트,
								완화곡선 등에 관한 특례)
								...
								<br><a href="/Info/ContentView?sid=L000007101_11$18_20211103" class="popup_view">제11조부터
									제18조까지</a> 및 <a
										href="/Info/ContentView?sid=L000007101_21_20211103"
										class="popup_view">제21조제3항</a>에도
								불구하고 경량전철의 경우
								캔트(고무차륜형식의 경우에는 횡기울기를 말한다)의 크기 및 체감거리, 완화곡선의 삽입기준 및 길이, 직선의 삽입길이, 본선의 기울기 한도, 측선의 기울기
								한도,
								...
								건축한계 등에 관하여는 차량의 형식 및 선로의 특성 등을 고려하여 시·도지사등이 다르게 정할 수 있다.<br>[본조신설 <span
										...
										onclick="open_miju('2010f10f8_3698')">2010.10.8<div
											id="2010f10f8_3698" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_76" style="display:none;" class="relative_law">_</div>
							<a id="P77" name="P77"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_77"
							                           class="popup_view">제77조</a></em>(곡선인
								궤도의
								중심 간격에 관한 특례)
								...
								궤도의 중심 간격은 건축한계의 안쪽 확대치수와 바깥쪽 확대치수를 더한 값 이상으로 확대하여야 한다.<br>[본조신설 <span
										...
										onclick="open_miju('2010f10f8_7864')">2010.10.8<div
											id="2010f10f8_7864" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_77" style="display:none;" class="relative_law">_</div>
							<a id="P78" name="P78"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_78"
							                           class="popup_view">제78조</a></em>(정거장의
								시설
								등에 관한 특례)
								<div class="btn-group  " style="display:none;" id="R_78">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br><a href="/Info/ContentView?sid=L000007101_30_20211103" class="popup_view">제30조</a>,
								<a
										href="/Info/ContentView?sid=L000007101_30X2_20211103"
										class="popup_view">제30조의2</a>,
								<a
										href="/Info/ContentView?sid=L000007101_30X3_20211103"
										class="popup_view">제30조의3</a>
								및 <a
										href="/Info/ContentView?sid=L000007101_31$35_20211103" class="popup_view">제31조부터
									제35조까지</a>의 규정에도 불구하고
								경량전철의 정거장에 설치하는 승강장·통로·출입구 등 승객의 도시철도 이용에 필요한 시설과 전기·통신설비 등의 세부기준은 국토교통부장관이 정하여 고시한다.
								[개정
								<span
							...
							<a id="P79" name="P79"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_79"
							                           class="popup_view">제79조</a></em>(전기방식에
								관한 특례)
								<div class="btn-group  " style="display:none;" id="R_79">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br><a href="/Info/ContentView?sid=L000007101_36_20211103"
								       class="popup_view">제36조제1호</a>에도
								불구하고 경량전철의 경우 전차선로에
								공급하는 전압 및 전기방식은 직류 750볼트 또는 1천500볼트 제3레일방식을 원칙으로 하되, 차량의 형식 또는 선로의 특성에 따라 다르게 할 수
								있다.<br>[본조신설
								<span
							...
							<a id="P80" name="P80"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_80"
							                           class="popup_view">제80조</a></em>(전선로에
								관한
								특례)
								<div class="btn-group  " style="display:none;" id="R_80">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br><a href="/Info/ContentView?sid=L000007101_37_20211103"
								       class="popup_view">제37조제1항</a>에도
								불구하고 경량전철의 경우 조명 및
								동력용 전원 공급이 이중화(二重化) 된 경우에는 전선로의 구성을 다르게 할 수 있다.<br>[본조신설 <span
										class="miju_num addition_num"
										onclick="open_miju('2010f10f8_1116')">2010.10.8<div
											id="2010f10f8_1116" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_80" style="display:none;" class="relative_law">_</div>
							<a id="P81" name="P81"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_81"
							                           class="popup_view">제81조</a></em>(전차선로의
								기울기에 관한 특례)
								...
								기울기 한도는 차량의 운행 조건 등을 고려하여 시·도지사등이 정한다.<br>[본조신설 <span class="miju_num addition_num"
											...
											id="2010f10f8_8541" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_81" style="display:none;" class="relative_law">_</div>
							<a id="P82" name="P82"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_82"
							                           class="popup_view">제82조</a></em>(비상통신장치의
								설치에 관한 특례)
								<div class="btn-group  " style="display:none;" id="R_82">
									<button type="button" class="btn btn-square">자료</button>
								</div>
								<br><a href="/Info/ContentView?sid=L000007101_46_20211103"
								       class="popup_view">제46조제6항</a>에도
							...
							<a id="P83" name="P83"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_83"
							                           class="popup_view">제83조</a></em>(선로의
								표지에
								관한 특례)
								...
								선로에는 필요에 따라 표지를 선택적으로 설치할 수 있다.<br>[본조신설 <span class="miju_num addition_num"
											...
											id="2010f10f8_2091" class="miju_box"> </div></span>]<br>
							</div>
							<div id="I_83" style="display:none;" class="relative_law">_</div>
							<a id="P84" name="P84"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_84"
							                           class="popup_view">제84조</a></em>(선로의
								대피시설에 관한 특례)
							...
							<a id="P85" name="P85"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_85"
							                           class="popup_view">제85조</a></em>(무인운전
								안전설비)
								...
								<br>경량전철에 무인운전을 적용하려는 경우에는 <a href="/Info/ContentView?sid=L000001460_11_20211103"
									...
									제11조</a>에 따라 고시된 한국산업표준 KS C IEC PAS62267의 자동도시철도교통(AUGT) 안전 요구사항에 따라 적절한 안전설비를 갖추어야
								한다.<br>[본조신설
								<span
							...
							<a id="P86" name="P86"> </a>
							<div class="normal"><em><a href="/Info/ContentView?sid=L000216E9101A2AB_86"
							                           class="popup_view">제86조</a></em>(노면전차형식에
								관한 특례)
							...
							<div class="normal" id="A1004">부칙 [2008.3.14, 제4호(정부조직법의 개정에 따른 감정평가에 관한 규칙 등)]<br>이 규칙은 공포한
								날부터
								시행한다.
							</div>
							<div class="normal" id="A1005">부칙 [2010.10.8 제290호]<br>이 규칙은 공포한 날부터 시행한다.</div>
							<div class="normal" id="A1006">부 칙[2013.3.23 제1호(국토교통부와 그 소속기관 직제 시행규칙)]<br>제1조(시행일) 이 규칙은
								공포한
								날부터 시행한다. &lt;단서 생략&gt;<br>제2조부터
								제5조까지 생략<br>제6조(다른 법령의 개정) ①부터 &lt;50&gt;까지 생략<br> &lt;51&gt; 도시철도건설규칙 일부를 다음과 같이
								개정한다.<br>
								제30조, 제34조, 제73조 및
								제78조 중 "국토해양부장관"을 각각 "국토교통부장관"으로 한다.<br> &lt;52&gt;부터 &lt;126&gt;까지 생략
							</div>
							<div class="normal" id="A1007">부 칙[2014.7.8 제106호(도시철도법 시행규칙)]<br>제1조(시행일) 이 규칙은 2014년 7월
								8일부터
								시행한다.<br>제2조(다른 법령의
								개정) ①부터 ③까지 생략<br> ④ 도시철도건설규칙 일부를 다음과 같이 개정한다.<br> 제1조 중 "「도시철도법」 제10조의2"를 "「도시철도법」
								제18조"로
								한다.<br> 제3조 단서 중
								"「도시철도법」제3조의2에 따른 도시철도기본계획"을 "「도시철도법」 제6조에 따른 노선별 도시철도기본계획"으로 한다. <br> ⑤부터 ⑧까지 생략<br>제3조
								생략<br></div>
							<div class="normal" id="A882">부 칙[2021.8.27 제882호(어려운 법령용어 정비를 위한 80개 국토교통부령 일부개정령)]<br>이
								규칙은
								공포한 날부터 시행한다. &lt;단서
								생략&gt;
							</div>
					...
					<!-- 2025.07 전체보기 버튼 클릭 시 뷰 팝업창 출력-->
					<div id='center-view-popup' class='center-view-popup'>
						<div class='scroll-y'>
							<div class='clear mb-15'>
								<button class='btn btn-close c-right' onclick="fn_remove_class_on('#center-view-popup')"><span class='icon-w30 icon-x-mark'></span></button>
							</div>
							<div id='result_area' class='popup_mov_area slide_mov_bottom'>
								<div id='result_sep' class='tab-list'>
									<button class='tab-li' onclick="fn_tab_list(this)" data-tab-id='#center-view-popup' data-tab-con='#result-D021'>주석서(4건)</button>
									<button class='tab-li' onclick="fn_tab_list(this)" data-tab-id='#center-view-popup' data-tab-con='#result-D000'>평석·논문(10건)</button>
									<button class='tab-li' onclick="fn_tab_list(this)" data-tab-id='#center-view-popup' data-tab-con='#result-P011'>리포트(1건)</button>
									<button class='tab-li' onclick="fn_tab_list(this)" data-tab-id='#center-view-popup' data-tab-con='#result-C000'>유사판례(20건)</button>
								</div>
								<div class="popup-list-wrap">
									<div id='result-D021' class="popup-con-wrap">
										<div class='list_order_pr'>
											<div class='article_popup_group_info'>간행물 동일 권호 자료는 발행일 최신순 최대 300건까지만
												지원합니다.
											</div>
											<div class='btn_option_outer clear'>
												<div class='select_area '>
													<p class='blind'>보기 개수 선택</p>
													<select id='sListChecker' name='sListChecker'>
										...
										<ol id='olist' class='list'>
											<li>
												<span class='list_num'>1</span>
												<div class='co_searchContent'>
													<h3>

														<a href='../Info/ContentView?sid=D0218B8E0FDD5670_100572'
														   class='popup_view'>[주석서] 형사소송법 / 제106조 [압수] </a>
														<br>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0218B8E0FDD5670_100936'
														   class='popup_view'>[주석서] 형사소송법 / 제173조 [감정에 필요한 처분] </a>
														<br>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0218B8E0FDD5670_101866'
														   class='popup_view'>[주석서] 형사소송법 / 제308조의2 [위법수집증거의 배제] </a>
														<br>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0218B8E0FDD5670_101919'
														   class='popup_view'>[주석서] 형사소송법 / 제318조 [당사자의 동의와 증거능력] </a>
														<br>
													</h3>
												</div>
											</li>
									...
									<div id='result-D000' class='popup-con-wrap'>
										<div class='list_order_pr'>
											<div class='article_popup_group_info'>간행물 동일 권호 자료는 발행일 최신순 최대 300건까지만
												지원합니다.
											</div>
											...
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0119FDFBF50078B'
														   class='popup_view'>[판례연구] 수사상 검증 - 강제채뇨와 강제채혈 - </a>
														<br><span class='list_meta'>박상진 / 최신중요 형사소송법판례: 수사와 증거 / 박영사 / 2025.02.28 / 8Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D011BF4DFAD636A9'
														   class='popup_view'>[판례연구] 압수 · 수색 · 검증과 영장주의의 예외(2) - 임의제출한
															물건의 ‘영치’ - </a>
														<br><span class='list_meta'>박상진 / 최신중요 형사소송법판례: 수사와 증거 / 박영사 / 2025.02.28 / 9Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D011464A2612EBD9'
														   class='popup_view'>[판례연구] 위법수집증거배제법칙(3)- 위법하게 수집한 증거와 이를 기초로
															획득한 2차 증거의 증거능력 - </a>
														<br><span class='list_meta'>박상진 / 최신중요 형사소송법판례: 수사와 증거 / 박영사 / 2025.02.28 / 9Page</span>
													</h3>
												</div>
											...
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D011C138370C80EB'
														   class='popup_view'>[판례연구] 수사: 대물적 강제수사(제 2 절 검증) </a>
														<br><span class='list_meta'>신양균, 조기영 / 판례교재 형사소송법(제4판) / 박영사 / 2024.02.29 / 8Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0116A346342A3A1'
														   class='popup_view'>[판례연구] 형사소송법: 제215조 압수, 수색, 검증 </a>
														<br><span class='list_meta'>이성철, 이정택, 이선호 / 형사실무와 판례 / 박영사 / 2022.08.30 / 6Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D011DB267CB56981'
														   class='popup_view'>[판례연구] 감정서의 증거능력 </a>
														<br><span class='list_meta'>이상원 / 형사소송법 핵심 판례 130선 (제5판) / 한국형사소송법학회 / 박영사 / 2020.07.20 / 2Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D011535033FB8C85'
														   class='popup_view'>[판례연구] 선행절차의 위법과 증거능력 (2) - 위법한 임의동행 </a>
														<br><span class='list_meta'>안경옥 / 형사소송법 핵심 판례 130선 (제5판) / 한국형사소송법학회 / 박영사 / 2020.07.20 / 4Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0119E1F3A6FB1A2'
														   class='popup_view'>[판례연구] 영장주의의 예외 (2) - 긴급 강제채혈 </a>
														<br><span class='list_meta'>김승주|김영규  / 형사소송법 핵심 판례 130선 (제5판) / 한국형사소송법학회 / 박영사 / 2020.07.20 / 4Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D0115F50529EB8A2'
														   class='popup_view'>[판례연구] 디지털 증거 압수수색 시 영장 범죄사실과 ‘관련성 있는’ 증거
															해석 기준과 무관 증거 발견 시 증거 확보 방법 - 대법원 2018. 4. 26. 선고 2018도2624
															판결 </a>
														<br><span class='list_meta'>김영미 / 형사판례연구 28 / 박영사 / 2020.06.30 / 62Page</span>
													</h3>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=D01137015CB994DE'
														   class='popup_view'>[판례연구] 위법수집증거배제법칙과 독수의 과실이론</a>
														<br><span class='list_meta'>이재상 / 형사소송법 기본판례  / 박영사 / 2013.04.25 / 19Page</span>
													</h3>
												</div>
											</li>
										</ol>
									...
									<div id='result-P011' class='popup-con-wrap'>
										<div class='list_order_pr'>
											<div class='article_popup_group_info'>간행물 동일 권호 자료는 발행일 최신순 최대 300건까지만 지원합니다.</div>
											<div class='btn_option_outer clear'>
												<div class='select_area'>
													<p class='blind'>보기 개수 선택</p>
													<select id='sListChecker' name='sListChecker'>
											...
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=P0116710E21FD8AB'
														   class='popup_view'>[로펌 리포트] 개인이 위법하게 수집한 증거의 증거능력 유무</a>
														<br>
													</h3>
												</div>
											</li>
									...
									<div id='result-C000' class='popup-con-wrap'>
										<div class='list_order_pr'>
											<div class='article_popup_group_info'>간행물 동일 권호 자료는 발행일 최신순 최대 300건까지만 지원합니다.</div>
											<div class='btn_option_outer clear'>
												<div class='select_area'>
											...
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C00002CBEBE72701' class='popup_view'>부산지방법원
															서부지원 2023. 11. 22 선고 2023고단2226 판결 【도로교통법위반(음주운전)】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..피 .. 고 .. 인 A .. ..검 .. .. .. .. ..
															.. 사 이정현(기소), 배국희(공판)주문 ..피고인을 벌금 600만 원에 처한다. ..피고인이 위 벌금을 납입하지 아니하는 경우
															10만 원을 1일로 환산한 기간 피고인을 노역장에 유치한다. ..위 벌금에 상당한 금액의 가납을 명한다.이 유<strong>범 죄
																사 실</strong> .. ..피고인은 2023... 3... 26... 03:30경 부산 사하구 B에 있는
															주차장에서부터 같은 구 C에 있는 도로에 이르기까지 약 1km 구간에서..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>2</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C0007E7C19AA1A47' class='popup_view'>수원지방법원
															2023. 9. 22 선고 2021노8184 판결 【도로교통법위반(음주운전), 도로교통법위반(무면허운전)】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..피 .. 고 .. 인 A ..항 .. 소 .. 인 검사 ..검
															.. .. .. .. .. .. 사 배상아(기소), 김용휘(공판)주문 ..원심판결을 파기한다... .. ..피고인을 벌금
															1,000,000원에 처한다. ..피고인이 위 벌금을 납입하지 아니하는 경우 100,000원을 1일로 환산한 기간 피고인을
															노역장에 유치한다.이 유<strong>1... 항소이유 요지(사실오인, 법리오해, 양형부당)</strong> .. ..이 사건
															피고인에 대한 채혈 및 혈액 압수 절차는 적법하고 이에 따른 2차적 증거..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>3</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000C9A23FC41CFD' class='popup_view'>수원지방법원
															2023. 8. 9 선고 2022고단6302 판결 【도로교통법위반(음주운전)】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..피 .. 고 .. 인 A ..검 .. .. .. .. .. ..
															사 노영진(기소), 김홍도(공판) ..변 .. 호 .. 인 변호사 안혜경(국선)주문 ..피고인을 벌금 1,300만 원에
															처한다... .. ..피고인이 위 벌금을 납입하지 아니하는 경우 10만 원을 1일로 환산한 기간 피고인을 노역장에 유치한다...
															.. ..위 벌금에 상당한 금액의 가납을 명한다.이 유<strong>범 죄 사 실</strong> .. ..피고인은 2022...
															10... 13... 00:30경 화성시 영천동 670-2에 있..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>4</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000DFFB005D942F' class='popup_view'>수원지방법원
															2023. 6. 15 선고 2022노1387 판결 【도로교통법위반(음주운전)】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..피 .. 고 .. 인 A .. ..항 .. 소 .. 인 피고인
															..검 .. .. .. .. .. .. 사 공민진(기소), 서민우(공판) ..변 .. 호 .. 인 변호사 이진경(국선)주문
															..피고인의 항소를 기각한다.이 유<strong>1... 항소이유의 요지(사실오인 및 법리오해)</strong> .. ..피고인은
															음주운전에 단속된 장소(이하 ..‘이 사건 단속장소’라고 하고 한다)에서 음주수치를 측정한 장소(이하 ..‘이 사건 측정장소’라고
															한다)까지 약 150m 거리를 경찰차에 탑승하여 이동하였는데..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>5</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C0005339193B0DD8' class='popup_view'>의정부지방법원
															2021. 5. 17 선고 2020구단5667 판결 【자동차운전면허취소처분취소】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..원 .. .. .. .. .. .. 고 A .. ..소송대리인
															법무법인 저스티스 ..담당변호사 도현택 ..피 .. .. .. .. .. .. 고 경기도북부지방경찰청장주문 ..1... 원고의
															청구를 기각한다... .. ..2... 소송비용은 원고가 부담한다.N청 구 취 지 ..피고가 2019... 8... 19...
															원고에 대하여 한 자동차운전면허(제1종 대형) 취소처분을 취소한다.이 유<strong>1... 처분의 경위 ..</strong>
															.. ..가... 원고는 2019... 2... 12... 2..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>6</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000E185F8D1B83B' class='popup_view'>수원지방법원
															2019. 4. 26 선고 2018고단6723 판결 【도로교통법위반(음주운전)】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..수원지방법원 .. ..판결 .. ..사건 2018고단6723
															도로교통법위반(음주운전) .. ..피고인 A .. ..검사 권예리(기소), 한윤석(공판) .. ..변호인 변호사 이은미(국선)
															.. ..판결선고 2019... 4... 26 ..주문 .. ..피고인은 무죄... .. .. .. 이유 .. ..1.공소사실의
															요지 .. ..피고인은 2018... 8... 21... 00:15경 용인시 수지구 신봉동 부근 도로부터 같은 구 B에 있는
															..'C'앞 도로까지 약 6km 구간에서 혈중알코올농도 0.313%의 술에 취한 상태로..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>7</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000E035CDC446BE' class='popup_view'>대법원
															2016. 12. 27 선고 2014두46850 판결 【자동차운전면허취소처분취소】 <span>[공2017상, 239]</span></a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> 음주운전 여부에 대한 조사 과정에서 운전자 본인의 동의를 받지
															아니하고 법원의 영장도 없이 한 혈액 채취 조사 결과를 근거로 한 운전면허 정지ㆍ취소 처분이 위법한지 여부(원칙적 적극) </p>
													</div>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000483A3C1BDCB1' class='popup_view'>대법원
															2014. 11. 13 선고 2013도1228 판결 【도로교통법위반ㆍ도로교통법위반(음주운전)】 <span>[공2014하, 2390]</span></a>
														<br><span><i class='icon-' data-icon=''></i>미성년자의 음주운전과 법정대리인의 채혈 동의 사건<i
																	class='icon-' data-icon=''></i></span>
													</h3>
													<div class='co_searchResults_summary'><p>음주운전과 관련한 도로교통법 위반죄의 범죄수사를 위하여 미성년자인
															피의자의 혈액채취가 필요한 경우,법정대리인이 의사능력 없는 피의자를 대리하여 채혈에 관한 동의를 할 수 있는지 여부(원칙적
															소극) </p></div>
												</div>
											</li>
											<li>
												...
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C0005AD481D5D267' class='popup_view'>창원지방법원
															2014. 5. 20 선고 2013구단995 판결 【자동차운전면허취소처분취소

															】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..창원지방법원 ..판 결 ..사 건 2013구단995
															자동차운전면허취소처분취소 ..원 고 A ..소송대리인 한려법무법인 ..담당변호사 이태우 ..피 고 경상남도지방경찰청장 ..변 론
															종 결 2014... 4... 2. ..판 결 선 고 2014... 5... 20 ..주 문 ..1... 피고가 2013...
															3... 6... 원고에게 한 자동차운전면허 취소처분을 취소한다. ..2... 소송비용은 피고가 부담한다. .. ..청 구 취 지
															..주문과 같다. .. ..이 유 ..1.처분의 경위 ..가... 원고는 2012... 1..</p></div>
												</div>
											</li>
											<li>
												<span class='list_num'>10</span>
												<div class='co_searchContent'>
													<h3>
														...
														<a href='../Info/ContentView?sid=C000DAD854E2C58B' class='popup_view'>인천지방법원
															2014. 3. 28 선고 2013노3554 판결 【도로교통법위반(음주운전)

															】</a>
														<br>
													</h3>
													<div class='co_searchResults_summary'><p> ..인천지방법원 ..제2형사부 ..판 결 ..사 건 2013노3554
															도로교통법위반(음주운전) ..피 고 인 A ..항 소 인 피고인 ..검 사 이은상(기소), 김민정(공판) ..변 호 인 변호사
															배◈철(국선) ..판 결 선 고 2014... 3... 28인천지방법원2013고정269520131129판결원 심 판 결
															인천지방법원 2013... 11... 29... 선고 2013고정2695 판결 ..주 문 ..원심판결을 파기한다. ..피고인은
															무죄. .. ..이 유 ..1... 이 사건 공소사실의 요지 ..피고인은 2013... ..</p></div>
												</div>
											</li>
										</ol>
										<!-- paging -->
			...
			<!-- 변경조문 시작 // -->
			<div id="changed-clause-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('changed-clause')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content">
						<p> 변경 조문</p>
						<!--?xml version="1.0" encoding="utf-16"?--><a id="P5001100" name="P5001100"> </a>
						<div class="normal"><em><a href="/Info/ContentView?sid=L000BB4EF08929A4_11" class="popup_view">제11조</a></em>(공포
							및 공고의 절차) <br>① 헌법개정·법률·조약·대통령령·총리령 및 부령의 공포와 헌법개정안·예산 및 예산 외 국고부담계약의 공고는 관보(官報)에 게재함으로써
							한다.<br>②
							<a href="/Info/ContentView?sid=L000001416_98_20181016" class="popup_view">「국회법」 제98조제3항</a>
							전단에 따라
							하는 국회의장의 법률 공포는 서울특별시에서 발행되는 둘 이상의 일간신문에 게재함으로써 한다.<br>③ 제1항에 따른 관보는 종이로 발행되는 관보(이하 "종이관보"라
							한다)와
							전자적인 형태로 발행되는 관보(이하 "전자관보"라 한다)로 운영한다. [개정 2018.10.16]<br>④ 관보의 내용 해석 및 적용 시기 등에 대하여 종이관보와
							전자관보는 동일한
							효력을 가진다. [개정 2018.10.16]<br>[전문개정 2010.3.12]
						</div>
						<p> 변경 조문 <span class="btn_close"></span></p>
						<!--?xml version="1.0" encoding="utf-16"?--><a id="P5001100" name="P5001100"> </a>
						<div class="normal"><em><a href="/Info/ContentView?sid=L000BB4EF08929A4_11" class="popup_view">제11조</a></em>(공포
							및 공고의 절차) <br>① 헌법개정·법률·조약·대통령령·총리령 및 부령의 공포와 헌법개정안·예산 및 예산 외 국고부담계약의 공고는 관보(官報)에 게재함으로써
							한다.<br>②
			...
			<div id="asterisk-form-popup" class="ct-popup-wrap">
				<div class="ct-frame str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('asterisk-form')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<!-- 별표서식 프레임 시작 // -->
						...
						<div class="case_info">
							<div class="normal">별표1 위탁받을 업무를 수행할 수 있는 전담인력 보유기준(제11조제2항제1호 관련) <br>
								<div class="ar">
									...
									<div class="btn-group">
										<button type="button" class="btn btn-none mr-5"
										        onclick="view.viewFileDown('L000', '013886#AHNEX#lawnb_18104616312.pdf', 'pdf')">
											PDF 다운로드
										</button>
										<button type="button" class="btn btn-none"
										        onclick="view.viewFileDown('L000', '013886#AHNEX#lawnb_18104616344.hwp', 'hwp')">
											HWP 다운로드
										</button>
									</div>
								</div>
			...
			<div id="revised-reasons-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('revised-reasons')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content" style="">
						<p> 제·개정이유 <span class="btn_close"></span></p>
						<div class="normal mgt0">[일부개정]<br>◇ 개정이유 및 주요내용<br> 전자관보가 제공된 이후에 대다수의 국민들이 인터넷 또는 모바일 웹으로 제공되는
							전자관보를 이용하고 있으나, 현행 규정에 따르면 관보는 종이관보를 기본으로 하고 전자관보는 보완적으로만 운영하고 있으며, 관보의 내용 해석 및 적용 시기 등에
							대해서도 종이관보를 우선으로 하고 전자관보는 부차적인 효력만을 갖도록 하고 있는 바, 국민 대다수가 전자관보를 이용하는 현실을 반영하고 전자관보에 대한 국민의 신뢰를
							보호하기 위하여 종이관보와 전자관보를 대등하게 운영하고, 관보의 내용 해석 및 적용시기 등에 대해서도 종이관보와 전자관보가 동일한 효력을 가지도록 하려는 것임.
						</div>
			...
			<div id="revised-sentence-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('revised-sentence')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content" style="">
						<p> 제·개정문 <span class="btn_close"></span></p>
						<div class="normal mgt0">⊙법률 제15798호<br>법령 등 공포에 관한 법률 일부개정법률<br>법령 등 공포에 관한 법률 일부를 다음과 같이 개정한다.<br>제11조제3항
							및 제4항을 각각 다음과 같이 한다.<br> ③ 제1항에 따른 관보는 종이로 발행되는 관보(이하 "종이관보"라 한다)와 전자적인 형태로 발행되는 관보(이하
							"전자관보"라 한다)로 운영한다.<br> ④ 관보의 내용 해석 및 적용 시기 등에 대하여 종이관보와 전자관보는 동일한 효력을 가진다. <br> 부칙<br>이 법은
							공포한 날부터 시행한다.
						</div>
			...
			<!-- // 제·개정문 -->
			<!-- 전자관보 시작 // -->
			<div id="official-gazette-popup" class="ct-popup-wrap">
				<div class="ct-frame str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('official-gazette')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<div class="ct-frame-bg">
						서식 프레임을 이곳에 위치해주세요
					</div>
			...
			<!-- // 전자관보 -->
			<!-- 관보정정 시작 // -->
			<div id="official-correction-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('official-correction')"><span
								class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content">
						<p> 관보 정정</p>
						<!--?xml version="1.0" encoding="utf-16"?--><a id="P5001100" name="P5001100"> </a>
