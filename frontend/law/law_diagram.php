			...
			<div class="str h-100p">
				<div class="ct-scroll">
					<div class="table_index tree">
						...
						<select id="select" class="select-css02 mt-10">
							<option>선택1</option>
							<option>선택2</option>
							<option>선택3</option>
							<option>선택4</option>
	...
	<div class="ct-center">
		<div class="ct-pt h-100p">
							...
							<div class="dis-t w-100p">
								<div class="dis-tr">
									<div class="tit-div dis-tc">
										<h2 class="tit">민법
											<a href="../precedent/precedent_contents.php" target="_blank" class="btn-none btn-s ml-10 fw-400">새창보기
												<span class="icon-out-box icon-w15-s ml-5"></span></a></h2>
			...
			<div id="changed-clause-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('changed-clause')"><span class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content">
						...
						<div class="normal"><em><a href="/Info/ContentView?sid=L000BB4EF08929A4_11" class="popup_view">제11조</a></em>(공포
							및 공고의 절차) <br>① 헌법개정·법률·조약·대통령령·총리령 및 부령의 공포와 헌법개정안·예산 및 예산 외 국고부담계약의 공고는 관보(官報)에 게재함으로써 한다.<br>②
							<a href="/Info/ContentView?sid=L000001416_98_20181016" class="popup_view">「국회법」 제98조제3항</a> 전단에 따라
							하는 국회의장의 법률 공포는 서울특별시에서 발행되는 둘 이상의 일간신문에 게재함으로써 한다.<br>③ 제1항에 따른 관보는 종이로 발행되는 관보(이하 "종이관보"라 한다)와
							전자적인 형태로 발행되는 관보(이하 "전자관보"라 한다)로 운영한다. [개정 2018.10.16]<br>④ 관보의 내용 해석 및 적용 시기 등에 대하여 종이관보와 전자관보는 동일한
			...
			<div id="official-gazette-popup" class="ct-popup-wrap">
				<div class="ct-frame str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('official-gazette')"><span class="icon-w30 icon-x-mark"></span></button>
					<div class="ct-frame-bg">
						서식 프레임을 이곳에 위치해주세요
					</div>
				</div>
			...
			<div id="official-correction-popup" class="ct-popup-wrap ct-popup-pd ct-popup-scroll-y">
				<div class="ct-bg str">
					<button class="btn btn-close str-rt" onclick="fn_ct_popup_close('official-correction')"><span class="icon-w30 icon-x-mark"></span></button>
					<div class="case_info" id="view_sub_content">
						<p> 관보 정정</p>
						<!--?xml version="1.0" encoding="utf-16"?--><a id="P5001100" name="P5001100"> </a>
						<div class="normal"><em><a href="/Info/ContentView?sid=L000BB4EF08929A4_11" class="popup_view">제11조</a></em>(공포
