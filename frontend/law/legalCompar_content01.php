	...
	<div class="step3-sub-header">
		<div class="w1600 clear">
			<div class="c-left clear">
				<a href="./legalCompar_content01.php" class="badge on">법규 비교</a>
				<a href="./legalCompar_content02.php" class="badge">본문 비교</a>
			</div>
		</div>
	</div>
	<!--	끝 : 서브헤더	-->
	...
	<div id="step3-container" class="step3-container">
		<div class="w1600 clear">
			...
			<div id="step3-con-wrap" class="h-100p">
				<div id='step3-search-wrap' class="con-div box_third flex_1 on">
					<div class="search-wrap b-b">
						<div class="dis-t w-100p str">
							...
							<div id='lrlist1' class='school_search' style="width: 100%;">
								<p class='fw-700 str'>
									법령명을 선택하세요.
					...
					<div class="title-area b-b str">
						<div class="str-lt btn_change_search" onclick="fn_toggle_on('#step3-search-wrap')">
					...
					<div id="step3-case-h" class="scroll-y case-div-m">
				...
				<div id="filter-wrap" class="con-div filter-wrap box_third flex_2">
					<div class="filter-top clear">
						<i class="icon- icon_info_search" data-icon=""></i>
						<div class="info_search_filter">키워드 기반 유사법규 추천 리스트입니다. 원하는 조건을 필터하여 이용해주시기 바랍니다.</div>
						<div class="search_filter_button" onclick="fn_filter_open()"><i class="icon-16" data-icon=""></i> </div>
					</div>
					<!-- 필터 팝업 // -->
					<div class="third_region_filter">
						<h3 class="hide">검색결과 필터</h3>
						<div class="close_region_filter" onclick="fn_filter_close()"><i class="icon-16" data-icon=""></i></div>
						<p class="submit_area"><span >적용</span><span class="_cancel" onclick=""><i class="icon-16" data-icon=""></i>적용취소</span></p>
						<div class="input_area">
							<h4>결과 내 재검색</h4>
							<input type="search" id="sWord" name="sWord" value="" placeholder="검색어" class="input-css01">
							<input type="search" id="sWord1" name="sWord1" value="" placeholder="제외어" class="input-css01">
						</div>
						<div class="accordion doc">
							<h4>필터</h4>
							<p class="mgt10">소관부처</p>
							...
							<p class="submit_area"><span onclick="javascript:lawrule.getSubSearch();">적용</span><span class="_cancel" onclick="javascript:lawrule.getInitSearch();"><i class="icon-16" data-icon=""></i>적용취소</span></p>
						</div>
					</div>
					<div class="region_filter_bg" onclick="fn_filter_close()"></div>
					<!-- // 필터 팝업-->
					<div class="scroll-y" style="height: calc(100% - 51px)">
						<div class="popup_mov_area1">
							<div class="list_header"><span>규칙명</span><span class="right">소관부처</span></div>
							<ol class="list">
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L0086B41861F52EF', this);" class="title_compare">서해안 <b>안전체험관</b> <b>설치</b> 및 <b>운영</b> 조례</a><br><span class="list_meta">충청남도  서산시  조례 제1607호  공포일 2021.08.01, 시행일 2021.08.01</span></h3>
									</div>
									<div class="co_oldnew_region">
										충청남도<br>서산시
									</div>
								</li>
								<li class="_this">
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L0085CB49031918C', this);" class="title_compare">구리시 <b>안전체험관</b> <b>설치</b> 및 <b>운영</b>에 관한 조례</a><br><span class="list_meta">경기도  구리시  조례 제1983호  공포일 2021.11.16, 시행일 2021.11.16</span></h3>
									</div>
									<div class="co_oldnew_region">
										경기도<br>구리시
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L008DBD32D33FB37', this);" class="title_compare">군산시 어린이 <b>안전체험관</b> <b>설치</b> 및 <b>운영</b> 조례</a><br><span class="list_meta">전북특별자치도  군산시  조례 제1974호  공포일 2022.07.15, 시행일 2022.07.15</span></h3>
									</div>
									<div class="co_oldnew_region">
										전북특별자치도<br>군산시
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L00847159B620140', this);" class="title_compare">무안군 해상<b>안전체험관</b> <b>설치</b> 및 <b>운영</b>에 관한 조례</a><br><span class="list_meta">전라남도  무안군  조례 제2783호  공포일 2023.03.27, 시행일 2023.03.27</span></h3>
									</div>
									<div class="co_oldnew_region">
										전라남도<br>무안군
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L008BCAE1208D53D', this);" class="title_compare">빛고을국민<b>안전체험관</b> <b>설치</b> 및 <b>운영</b> 조례</a><br><span class="list_meta">광주광역시  조례 제6419호  공포일 2024.08.07, 시행일 2024.08.07</span></h3>
									</div>
									<div class="co_oldnew_region">
										광주광역시<br>
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L008323AFC5D452E', this);" class="title_compare">연천군 <b>안전</b>문화<b>체험관</b> <b>설치</b> 및 <b>운영</b>에 관한 조례</a><br><span class="list_meta">경기도  연천군  조례 제3671호  공포일 2020.07.14, 시행일 2020.07.14</span></h3>
									</div>
									<div class="co_oldnew_region">
										경기도<br>연천군
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L0088918C81CFC3C', this);" class="title_compare">울산<b>안전체험관</b>의 <b>설치</b>와 <b>운영</b>에 관한 조례</a><br><span class="list_meta">울산광역시  조례 제2945호  공포일 2024.05.09, 시행일 2024.05.09</span></h3>
									</div>
									<div class="co_oldnew_region">
										울산광역시<br>
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L0089B96B448BF20', this);" class="title_compare">충청북도 <b>안전체험관</b> <b>설치</b> 및 <b>운영</b>에 관한 조례</a><br><span class="list_meta">충청북도  조례 제5077호  공포일 2024.04.05, 시행일 2024.04.05</span></h3>
									</div>
									<div class="co_oldnew_region">
										충청북도<br>
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L00835C1295C1C09', this);" class="title_compare">대구광역시 수성구 <b>한국</b>전통문화<b>체험관</b> <b>운영</b>에 관한 조례</a><br><span class="list_meta">대구광역시  수성구  조례 제1658호  공포일 2023.05.30, 시행일 2023.05.30</span></h3>
									</div>
									<div class="co_oldnew_region">
										대구광역시<br>수성구
									</div>
								...
								<li>
									<div class="co_searchContent">
										<h3><a href="javascript:;" onclick="lawrule.goSelectRuleView('L008AC7A4EC0171D', this);" class="title_compare">경상남도 <b>안전체험관</b> <b>운영</b> 조례</a><br><span class="list_meta">경상남도  조례 제5736호  공포일 2024.09.26, 시행일 2024.09.26</span></h3>
									</div>
									<div class="co_oldnew_region">
										경상남도<br>
									</div>
				...
				<div class="con-div box_third flex_3">
					...
					<div class="scroll-y case-div-m" style="height: calc(100% - 168px)">
						<div class="box_third joView" id="wrapper_sam">
							<div class="no_search_result" style="display: none;">
								선택한 법규가 없습니다.<br>
								기준법규 설정 후 이용해주세요.
