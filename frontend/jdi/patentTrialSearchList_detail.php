							...
							<div class="accordion-body">
								<ul class="keyword-list list-block">
									...
									<li>
										...
										<label for="keyword-1-5">등록번호</label>
									</li>
	                                <li>
	                                    <input type="checkbox" id="keyword-1-6" value="" name="keyword-list">
	                                    <label for="keyword-1-6">출원번호</label>
	                                </li>
								</ul>
							</div>
						</div>
	                ...
	                <li class="accordion-item">
	                    ...
	                    <div id="left-con-accordion02" class="accordion-collapse collapse" data-bs-parent="#left-con-accordion">
	                        <div class="accordion-body">
	                            <ul class="keyword-list list-inline">
	                                <li>
	                                    <input type="checkbox" id="keyword-3-1" value="" name="keyword-list02">
	                                    <label for="keyword-3-1">결정계</label>
	                                </li>
	                                <li>
	                                    <input type="checkbox" id="keyword-3-2" value="" name="keyword-list02">
	                                    <label for="keyword-3-2">당사자계</label>
	                                </li>
	                            </ul>
	                        </div>
	                    </div>
	                ...
	                <li class="accordion-item">
	                    ...
	                    <div id="left-con-accordion01" class="accordion-collapse collapse" data-bs-parent="#left-con-accordion">
	                        <div class="accordion-body">
	                            <ul class="keyword-list list-block">
	                                <li>
	                                    <input type="checkbox" id="keyword-4-1" value="" name="keyword-list">
	                                    <label for="keyword-4-1">특허심판원(심판소+항고심판소)</label>
	                                </li>
	                                <li>
	                                    <input type="checkbox" id="keyword-4-2" value="" name="keyword-list">
	                                    <label for="keyword-4-2">특허법원</label>
	                                </li>
	                                <li>
	                                    <input type="checkbox" id="keyword-4-3" value="" name="keyword-list">
	                                    <label for="keyword-4-3">대법원</label>
	                                </li>
	                            </ul>
	                        </div>
	                    </div>
						...
						<div class="c-left ml-10">
							<div class="btn-list btn-list-m btn-list-none">
								...
								<button class="btn pr-5" onclick="fn_order_con(this);">
									<span class="icon icon-order resent">심결일</span>
								</button>
							</div>
						</div>
				...
				<ul class="content-ul">
					<li>
						<div class="li-con">
							...
							<div class="txt-div">
								<a href="" class="txt01">특허심판원 2005. 2.23 2004월 4804 [2003년 서비스표출원 제 20344호 거절결정불복심판]</a>
                                <p class="txt05">
                                    부동산 친구<br>
                                    출원번호 : 213912390123012 / 심판no,128921312321
                                </p>
                                <p class="txt04 mt-5">
