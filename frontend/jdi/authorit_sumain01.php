...
<div class="container-wrap">
	<div class="container-inner">
		...
		<div class="container-center">
			<h2 class="sub-main-tit clear">유권해석 검색</h2>
			<div class="bg-border">
				<div class="sub-main-pd">
					<div class="sub-main-tab-warp clear">
						<ul class="sub-main-tab-ul c-left">
							<li class="on"><a href="./authorit_sumain01.php">유권해석 검색</a></li>
							<li><a href="./authorit_sumain02.php">주요 회신기관별 유권해석</a></li>
						</ul>
											...
											<div class="dis-tc">
												...
												<ul class="keyword-chk-list mt-10">
													...
													<li>
														...
														<label for="keyword-1-2">관련법령</label>
													</li>
													<li>
														<input type="checkbox" id="keyword-1-3" value="" name="keyword-list">
														<label for="keyword-1-3">질의요지</label>
													</li>
													<li>
													...
													<li>
														...
														<label for="keyword-1-5">문서번호</label>
													</li>
												</ul>
											</div>
										</div>
								...
								<div id="toggle01" class="search-area-con input-box str mt-20">
									<div class="input-box str">
										<div class="dis-t">
											<div class="dis-tr">
												<div class="dis-th">
													<label for="keyword-except">회신기관</label>
												</div>
												<div class="dis-tc">
									...
									<div class="input-box str">
										<div class="dis-t">
											<div class="dis-tr">
												<div class="dis-th">
													<label for="keyword-except">질의기관</label>
												</div>
												<div class="dis-tc">
													<select id="" class="select-css01">
														<option>전체</option>
									...
									<div class="input-box str">
										<div class="dis-t">
											<div class="dis-tr">
												<div class="dis-th">
													<label for="keyword-except">회신일자</label>
												</div>
												<div class="dis-tc">
													<div class="dis-t">
														<div class="dis-tr">
