...
<div class="w-800px join-wrap">
	<div class="clear mb-30">
		<h2 class="c-left fs-18">법인회원 가입</h2>
		<div class="c-right">
			<ol class="ol-list01">
				<li><p>약관동의</p></li>
	...
	<div class="container bg-border">
			...
			<div class="pt-10">
				<div class="w-360px m-auto">
					...
					<div class="input-div mt-10">
						<div class="input-hd fw-500">상호명 <span class="star"></span></div>
						<input type="text" class="input-css01">
					</div>
					<div class="input-div mt-10">
						<div class="input-hd fw-500">사업자등록 번호 <span class="star"></span></div>
						...
						<p class="c-blue fs-14 mt-10">
							가입 완료 후 사업자등록증을 메일로 발송해주시기 바랍니다.<br>
							cs.lawnb@tr.com
						</p>
					</div>
				</div>
		...
		<div class="border-b mt-30 pb-40">
			<h3>사용자 정보 입력</h3>
			<p class="star">표시는 필수항목이며, 이름과 아이디(ID)는 가입 후 변경할 수 없습니다.<br>입력정보는 법인 Main ID로 가입됩니다. 가입 후 회원정보 관리에서 법인 내 다른 사용자를 위해 Sub ID를 생성할 수 있습니다.</p>
			<div class="pt-40">
				<div class="w-360px m-auto">
					<div class="input-div">
					...
					<div class="input-div">
						<div class="input-hd fw-500">
							...
							<span class="c-gray-l fw-400 fs-12">(만 14세 이상부터 가입이 가능합니다.)</span>
						</div>
						<div class="dis-t w-100p">
							<div class="dis-tr">
					...
					<div class="input-div">
						<div class="input-hd fw-500">
							...
							<span class="c-gray-l fs-12 fw-400">일반전화번호 입력시 '-' 없이 입력</span>
						</div>
						<input type="text" class="input-css01">
					</div>
					<div class="input-div">
						...
						<div class="dis-t w-100p">
							...
							<div class="dis-tr">
								...
								<div class="dis-tc v-t w-130px  pt-10">
									<input type="text" class="input-css01" placeholder="상세주소 입력">
								</div>
							</div>
						</div>
					</div>
