...
<div class="container-wrap">
	<div class="container-inner">
	    ...
	    <div class="container-center">
	        <h2 class="sub-main-tit clear">논문 검색</h2>
	        <div class="bg-border">
	            <div class="sub-main-pd">
	                <div class="sub-main-tab-warp clear">
	                    <ul class="sub-main-tab-ul c-left">
	                        <li class="on"><a href="./plainPaper_submain01.php">논문 검색</a></li>
	                        <li><a href="./plainPaper_submain02.php">학회논문/실무논문</a></li>
	                        <li><a href="./plainPaper_submain03.php">나의 학회/간행물</a></li>
	                    </ul>
	                                    ...
	                                    <div class="dis-tr">
	                                        ...
	                                        <div class="dis-tc">
		                                        ...
		                                        <ul class="keyword-chk-list mt-10">
			                                        ...
			                                        <li>
				                                        <input type="checkbox" id="keyword-1-5" value="" name="keyword-list" checked>
				                                        <label for="keyword-1-5">대상판례</label>
			                                        </li>
			                                        <li>
				                    ...
				                    <div class="input-box str">
					                    <div class="input-box str">
						                    <div class="dis-t">
							                    <div class="dis-tr">
								                    <div class="dis-th">
									                    <label for="keyword-except">검색범위</label>
								                    </div>
								                    <div class="dis-tc clear">
									                    <ul class="keyword-chk-list">
										                    <li>
											                    <input type="checkbox" id="keyword-2-1" value="" name="keyword-list" checked>
											                    <label for="keyword-2-1">전체</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-2" value="" name="keyword-list" checked>
											                    <label for="keyword-2-2">학회논문</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-3" value="" name="keyword-list" checked>
											                    <label for="keyword-2-3">법률잡지</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-4" value="" name="keyword-list" checked>
											                    <label for="keyword-2-4">공공간행물</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-5" value="" name="keyword-list" checked>
											                    <label for="keyword-2-5">판례연구</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-6" value="" name="keyword-list" checked>
											                    <label for="keyword-2-6">실무논문</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-7" value="" name="keyword-list" checked>
											                    <label for="keyword-2-7">천자평석</label>
										                    </li>
										                    <li>
											                    <input type="checkbox" id="keyword-2-8" value="" name="keyword-list" checked>
											                    <label for="keyword-2-8">유럽법제동향</label>
										                    </li>
									                    </ul>
								                    </div>
							                    </div>
