...
<div class="container-wrap">
	<div class="container-inner">
	    ...
	    <div class="container-center">
	        <h2 class="sub-main-tit clear">유럽법제동향 검색</h2>
	        <div class="bg-border">
	            <div class="sub-main-pd">
	                <div class="sub-main-tab-warp clear">
	                    <ul class="sub-main-tab-ul c-left">
	                        <li class="on"><a href="./europe_submain01.php">유럽법제동향 검색</a></li>
	                        <li><a href="./europe_submain02.php">분야별 유럽법제동향</a></li>
	                    </ul>
						                    ...
						                    <div class="dis-tr">
							                    ...
							                    <div class="dis-tc clear">
								                    <ul class="keyword-chk-list">
									                    ...
									                    <li>
										                    <input type="checkbox" id="keyword-1-2" value="" name="keyword-list">
										                    <label for="keyword-1-2">헌법판례연구</label>
									                    </li>
									                    <li>
										                    <input type="checkbox" id="keyword-1-3" value="" name="keyword-list">
										                    <label for="keyword-1-3">민사판례연구</label>
									                    </li>
									                    <li>
										                    <input type="checkbox" id="keyword-1-4" value="" name="keyword-list">
										                    <label for="keyword-1-4">형사판례연구</label>
									                    </li>
									                    <li>
										                    <input type="checkbox" id="keyword-1-5" value="" name="keyword-list">
										                    <label for="keyword-1-5">행정판례연구</label>
									                    </li>
									                    <li>
										                    <input type="checkbox" id="keyword-1-6" value="" name="keyword-list">
										                    <label for="keyword-1-6">독일법령동향</label>
									                    </li>
								                    </ul>
							                    </div>
						                    </div>
