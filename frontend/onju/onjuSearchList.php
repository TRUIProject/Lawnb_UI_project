		...
		<div class="container-right">
			...
			<div class="reset-con-list pt-40">
				<div class="reset-con-item">
					<h3 class="right-header">신간/개정 주석서</h3>
					<div class="noti_onju_div">
						<ul class="noti_onju_list">
							<li>
								<span class="badge-square square-blue square-ls">신간</span>
								<span class="badge-square square-green square-ls mr-5">기본법</span>
								<a href="" class="fs-14 c-blue">민법</a>
							</li>
						</ul>
					</div>
					<div class="noti_onju_div">
						<ul class="noti_onju_list">
							<li>
								<span class="badge-square square-blue square-ls mr-5">신간</span>
								<a href="" class="fs-14 c-blue">민법</a>
							</li>
							<li>
								<span class="badge-square square-blue square-ls mr-5">개정판</span>
								<a href="" class="fs-14 c-blue">전자서명법</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="tab-button-wrap clear">
					...
					<div class="r-div c-right clear">
						...
						<div class="dropdown c-left ml-10">
							<button class="btn btn-none btn-m dropdown-toggle" type="button" data-bs-toggle="dropdown"
							        aria-expanded="false">
								20개
							</button>
					...
					<li>
						<div class="li-con">
							...
							<div class="txt-div">
								...
								<p class="c-gray-l fs-14 mt-5">제안자 : 의원 / 제안일 2023.10.4 제안자 : 의원 / 제안일 2023.10.4</p>
								<p class="text01 mt-5">
									<span class="badge-square square-d-gray square-ls mr-5">법령</span> 제안이유 및 주요내용 현행법은 개업공인중개사가 등록관청의 관할..이러한 유령 중개사무소는 사무실이 실재하지 않아 전세 사기 등 중개거래사고가
									...
									등록관청이 해당 중개사무소의 개설등록을 취소할 수 있도록 하는 법적 근거를 마련하여 <span
											class="highlight-yellow">부동산</span> 거래사고 발생을 사전에 차단하고자 함(제13조제7항 신설 등)....<br>
									<span class="badge-square square-blue square-ls mr-5">주석서</span> 제안이유 및 주요내용 현행법은 개업공인중개사가 등록관청의 관할..이러한 유령 중개사무소는 사무실이 실재하지 않아 전세 사기 등 중개거래사고가
									발생하더라고 직접 찾아가 책임을 물을 수 없어 <span class="highlight-yellow">부동산</span>거래 피해자가 발생할 우려가
									매우 큰 상황임... 이에 개업공인중개사가 중개사무소를 다른 용로도 사용하거나 다른 용로도 사용하려는 사람에게 대여하지 못하도록 하고 이를 위한반 경우
									등록관청이 해당 중개사무소의 개설등록을 취소할 수 있도록 하는 법적 근거를 마련하여 <span
