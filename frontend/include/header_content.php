...
<header id="header" class="header_wrap">
	<div class="header-pd header-bg">
		<div class="w1600 str clear">
			...
			<button class='btn-new'>NEW <br>콘텐츠 중심</button>
		</div>
		<div class="w1200 str clear header-02">
			<h1 class="logo-div c-left"><a href="../main/main_search.php"><img src="../images/common/logo.png" alt="로앤비" /></a></h1>
