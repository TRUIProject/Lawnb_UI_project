...
<div class="container-wrap">
	<div class="container-inner">
		<div class="container-center">
			<h2 class="sub-main-tit clear">로펌 리포트 검색</h2>
			<div class="bg-border">
				<div class="sub-main-pd">
					<div class="sub-main-tab-warp clear">
						<ul class="sub-main-tab-ul c-left">
							<li class="on"><a href="./corporate_submain02.php">로펌 리포트 검색</a></li>
							<li><a href="./corporate_submain03.php">제공로펌</a></li>
						</ul>
							...
							<div class="con doc">
								...
								<div class="input-box str">
									<div class="dis-t">
										<div class="dis-tr">
											<div class="dis-th">
												<label for="keyword-search">제외어</label>
											</div>
											<div class="dis-tc">
												<input id="keyword-search" type="text" class="input-css01" placeholder="제외어">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="dis-t">
										<div class="dis-tr">
											...
											<div class="dis-tc">
												...
												<p class="mt-5 c-gray-l"><span class="icon icon-w20 icon-exclamation-circle mr-2"></span>원문 파일이 이미지 PDF인 경우 본문 검색이 제한 될 수 있습니다.</p>
											</div>
										</div>
									</div>
								</div>
								...
								<div id="toggle01" class="search-area-con input-box str mt-20">
									<div class="input-box str">
										<div class="dis-t">
											<div class="dis-tr">
												<div class="dis-th">
													<label for="keyword-except">분류</label>
												</div>
