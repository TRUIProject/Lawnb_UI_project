...
<div class="ct-wrap">
	<div class="ct-left">
		<div class="ct-pt h-100p">
			<div class="str h-100p">
				<div class="ct-scroll">
					<section class="result-tab">
						<h4 class="hide">메뉴</h4>
						<ul>
							<li><a href="lawFirm_content01.php">기본정보</a></li>
							<li class="this-page"><a href="lawFirm_content02.php">구성원정보</a></li>
							<li><a href="lawFirm_content03.php">로펌 소식</a></li>
							<li><a href="lawFirm_content04.php">업무사례</a></li>
							<li><a href="lawFirm_content05.php">로펌 리포트</a></li>
						</ul>
					</section>
					<div class="accordion">
						<div class="accordion-item b-none">
							<h2 class="accordion-header">검색필터</h2>
							<div class="accordion-collapse collapse">
								<div class="accordion-body test-result">
									<div class="border-b-dash pt-10 pb-10">
										<div class="dis-t">
											<div class="dis-tr">
												<div class="dis-tc div-tit pr-2 w-113px">현직</div>
												<div class="dis-tc">
										...
										<div class="dis-t mt-10">
											<div class="dis-tr">
												<div class="dis-tc div-tit pr-2 w-113px">시험종류</div>
												<div class="dis-tc">
													<select id="select" class="select-css01">
														<option>선택</option>
														<option>선택2</option>
					...
					<div class="btn-wrap border-top">
						<div class="ta-c">
							<button class="btn btn-blue btn-m icon-reset w-95px">초기화</button>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="ct-center">
		<div class="ct-pt h-100p">
			<div class="str h-100p ct-scroll">
				<div class="center-tit">
					<h2 class="txt01 mb-30">법무법인(유한) 광장</h2>
					<div class="clear mb-15">
						<div class="c-left">
							<p class="txt02">구성원정보</p>
						</div>
						<div class="c-right">
							<div class="dis-t">
								<div class="dis-tr">
									<div class="dis-tc pr-10">
										<select id="select" class="select-css01">
											<option>분사무소 선택</option>
											<option>선택2</option>
											<option>선택3</option>
											<option>선택4</option>
										</select>
									</div>
									<div class="dis-tc pr-5"><input type="text" class="input-css01" placeholder="이름"></div>
									<div class="dis-tc"><button class="btn-orange btn-m dis-b">검색</button></div>
								</div>
							</div>
						</div>
					</div>
					<div class="tab-button-wrap clear mb-10">
						<div class="c-left">
							<p class="fs-14">576건</p>
						</div>
						<div class="r-div c-right clear">
							<div class="c-left ml-10">
								<div class="btn-list btn-list-m btn-list-none dis-b">
									<button class="btn on" onclick="fn_order_con(this);">
										<span class="icon icon-order resent">이름</span>
									</button>
